...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Wn,depthTest:!1,depthWrite:!1})}function Fl(){return new Ei({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:lo(),fragmentShader:`
		...
		`,blending:Wn,depthTest:!1,depthWrite:!1})}function Bl(){return new Ei({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:lo(),fragmentShader:`
	...
	`}function bm(r){let t=new WeakMap,e=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===Da||l===Ua,u=l===tr||l===er;if(c||u)if(o.isRenderTargetTexture&&o.needsPMREMUpdate===!0){o.needsPMREMUpdate=!1;let f=t.get(o);return e===null&&(e=new Nl(r)),f=c?e.fromEquirectangular(o,f):e.fromCubemap(o,f),t.set(o,f),f.texture}else{if(t.has(o))return t.get(o).texture;{const f=o.image;if(c&&f&&f.height>0||u&&f&&i(f)){e===null&&(e=new Nl(r));const h=c?e.fromEquirectangular(o):e.fromCubemap(o);return t.set(o,h),o.addEventListener("dispose",s),h.texture}else return null}}}return o}function i(o){let l=0;const c=6;for(let u=0;u<c;u++)o[u]!==void 0&&l++;return l===c}function s(o){const l=o.target;l.removeEventListener("dispose",s);const c=t.get(l);c!==void 0&&(t.delete(l),c.dispose())}function a(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:a}}function Am(r){const t={};function e(n){if(t[n]!==void 0)return t[n];let i;switch(n){case"WEBGL_depth_texture":i=r.getExtension("WEBGL_depth_texture")||r.getExtension("MOZ_WEBGL_depth_texture")||r.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=r.getExtension("EXT_texture_filter_anisotropic")||r.getExtension("MOZ_EXT_texture_filter_anisotropic")||r.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=r.getExtension("WEBGL_compressed_texture_s3tc")||r.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=r.getExtension("WEBGL_compressed_texture_pvrtc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=r.getExtension(n)}return t[n]=i,i}return{has:function(n){return e(n)!==null},init:function(n){n.isWebGL2?e("EXT_color_buffer_float"):(e("WEBGL_depth_texture"),e("OES_texture_float"),e("OES_texture_half_float"),e("OES_texture_half_float_linear"),e("OES_standard_derivatives"),e("OES_element_index_uint"),e("OES_vertex_array_object"),e("ANGLE_instanced_arrays")),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture")},get:function(n){const i=e(n);return i===null&&console.warn("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function wm(r,t,e,n){const i={},s=new WeakMap;function a(f){const h=f.target;h.index!==null&&t.remove(h.index);for(const g in h.attributes)t.remove(h.attributes[g]);for(const g in h.morphAttributes){const _=h.morphAttributes[g];for(let p=0,d=_.length;p<d;p++)t.remove(_[p])}h.removeEventListener("dispose",a),delete i[h.id];const m=s.get(h);m&&(t.remove(m),s.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,e.memory.geometries--}function o(f,h){return i[h.id]===!0||(h.addEventListener("dispose",a),i[h.id]=!0,e.memory.geometries++),h}function l(f){const h=f.attributes;for(const g in h)t.update(h[g],r.ARRAY_BUFFER);const m=f.morphAttributes;for(const g in m){const _=m[g];for(let p=0,d=_.length;p<d;p++)t.update(_[p],r.ARRAY_BUFFER)}}function c(f){const h=[],m=f.index,g=f.attributes.position;let _=0;if(m!==null){const E=m.array;_=m.version;for(let x=0,S=E.length;x<S;x+=3){const M=E[x+0],w=E[x+1],A=E[x+2];h.push(M,w,w,A,A,M)}}else{const E=g.array;_=g.version;for(let x=0,S=E.length/3-1;x<S;x+=3){const M=x+0,w=x+1,A=x+2;h.push(M,w,w,A,A,M)}}const p=new(Fc(h)?Xc:Wc)(h,1);p.version=_;const d=s.get(f);d&&t.remove(d),s.set(f,p)}function u(f){const h=s.get(f);if(h){const m=f.index;m!==null&&h.version<m.version&&c(f)}else c(f);return s.get(f)}return{get:o,update:l,getWireframeAttribute:u}}function Rm(r,t,e,n){const i=n.isWebGL2;let s;function a(h){s=h}let o,l;function c(h){o=h.type,l=h.bytesPerElement}function u(h,m){r.drawElements(s,m,o,h*l),e.update(m,s,1)}function f(h,m,g){if(g===0)return;let _,p;if(i)_=r,p="drawElementsInstanced";else if(_=t.get("ANGLE_instanced_arrays"),p="drawElementsInstancedANGLE",_===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}_[p](s,m,o,h*l,g),e.update(m,s,g)}this.setMode=a,this.setIndex=c,this.render=u,this.renderInstances=f}function Cm(r){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(e.calls++,a){case r.TRIANGLES:e.triangles+=o*(s/3);break;case r.LINES:e.lines+=o*(s/2);break;case r.LINE_STRIP:e.lines+=o*(s-1);break;case r.LINE_LOOP:e.lines+=o*s;break;case r.POINTS:e.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function i(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:i,update:n}}function Pm(r,t){return r[0]-t[0]}function Lm(r,t){return Math.abs(t[1])-Math.abs(r[1])}function Dm(r,t,e){const n={},i=new Float32Array(8),s=new WeakMap,a=new qt,o=[];for(let c=0;c<8;c++)o[c]=[c,0];function l(c,u,f){const h=c.morphTargetInfluences;if(t.isWebGL2===!0){const g=u.morphAttributes.position||u.morphAttributes.normal||u.morphAttributes.color,_=g!==void 0?g.length:0;let p=s.get(u);if(p===void 0||p.count!==_){let B=function(){U.dispose(),s.delete(u),u.removeEventListener("dispose",B)};var m=B;p!==void 0&&p.texture.dispose();const x=u.morphAttributes.position!==void 0,S=u.morphAttributes.normal!==void 0,M=u.morphAttributes.color!==void 0,w=u.morphAttributes.position||[],A=u.morphAttributes.normal||[],L=u.morphAttributes.color||[];let v=0;x===!0&&(v=1),S===!0&&(v=2),M===!0&&(v=3);let b=u.attributes.position.count*v,X=1;b>t.maxTextureSize&&(X=Math.ceil(b/t.maxTextureSize),b=t.maxTextureSize);const Z=new Float32Array(b*X*4*_),U=new Gc(Z,b,X,_);U.type=Gn,U.needsUpdate=!0;const F=v*4;for(let K=0;K<_;K++){const G=w[K],W=A[K],Q=L[K],$=b*X*4*K;for(let z=0;z<G.count;z++){const k=z*F;x===!0&&(a.fromBufferAttribute(G,z),Z[$+k+0]=a.x,Z[$+k+1]=a.y,Z[$+k+2]=a.z,Z[$+k+3]=0),S===!0&&(a.fromBufferAttribute(W,z),Z[$+k+4]=a.x,Z[$+k+5]=a.y,Z[$+k+6]=a.z,Z[$+k+7]=0),M===!0&&(a.fromBufferAttribute(Q,z),Z[$+k+8]=a.x,Z[$+k+9]=a.y,Z[$+k+10]=a.z,Z[$+k+11]=Q.itemSize===4?a.w:1)}}p={count:_,texture:U,size:new Rt(b,X)},s.set(u,p),u.addEventListener("dispose",B)}let d=0;for(let x=0;x<h.length;x++)d+=h[x];const E=u.morphTargetsRelative?1:1-d;f.getUniforms().setValue(r,"morphTargetBaseInfluence",E),f.getUniforms().setValue(r,"morphTargetInfluences",h),f.getUniforms().setValue(r,"morphTargetsTexture",p.texture,e),f.getUniforms().setValue(r,"morphTargetsTextureSize",p.size)}else{const g=h===void 0?0:h.length;let _=n[u.id];if(_===void 0||_.length!==g){_=[];for(let S=0;S<g;S++)_[S]=[S,0];n[u.id]=_}for(let S=0;S<g;S++){const M=_[S];M[0]=S,M[1]=h[S]}_.sort(Lm);for(let S=0;S<8;S++)S<g&&_[S][1]?(o[S][0]=_[S][0],o[S][1]=_[S][1]):(o[S][0]=Number.MAX_SAFE_INTEGER,o[S][1]=0);o.sort(Pm);const p=u.morphAttributes.position,d=u.morphAttributes.normal;let E=0;for(let S=0;S<8;S++){const M=o[S],w=M[0],A=M[1];w!==Number.MAX_SAFE_INTEGER&&A?(p&&u.getAttribute("morphTarget"+S)!==p[w]&&u.setAttribute("morphTarget"+S,p[w]),d&&u.getAttribute("morphNormal"+S)!==d[w]&&u.setAttribute("morphNormal"+S,d[w]),i[S]=A,E+=A):(p&&u.hasAttribute("morphTarget"+S)===!0&&u.deleteAttribute("morphTarget"+S),d&&u.hasAttribute("morphNormal"+S)===!0&&u.deleteAttribute("morphNormal"+S),i[S]=0)}const x=u.morphTargetsRelative?1:1-E;f.getUniforms().setValue(r,"morphTargetBaseInfluence",x),f.getUniforms().setValue(r,"morphTargetInfluences",i)}}return{update:l}}function Um(r,t,e,n){let i=new WeakMap;function s(l){const c=n.render.frame,u=l.geometry,f=t.get(l,u);if(i.get(f)!==c&&(t.update(f),i.set(f,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),i.get(l)!==c&&(e.update(l.instanceMatrix,r.ARRAY_BUFFER),l.instanceColor!==null&&e.update(l.instanceColor,r.ARRAY_BUFFER),i.set(l,c))),l.isSkinnedMesh){const h=l.skeleton;i.get(h)!==c&&(h.update(),i.set(h,c))}return f}function a(){i=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),e.remove(c.instanceMatrix),c.instanceColor!==null&&e.remove(c.instanceColor)}return{update:s,dispose:a}}const Zc=new ke,$c=new Gc,Jc=new vf,Qc=new jc,zl=[],Gl=[],Hl=new Float32Array(16),kl=new Float32Array(9),Vl=new Float32Array(4);function ur(r,t,e){const n=r[0];if(n<=0||n>0)return r;const i=t*e;let s=zl[i];if(s===void 0&&(s=new Float32Array(i),zl[i]=s),t!==0){n.toArray(s,0);for(let a=1,o=0;a!==t;++a)o+=e,r[a].toArray(s,o)}return s}function oe(r,t){if(r.length!==t.length)return!1;for(let e=0,n=r.length;e<n;e++)if(r[e]!==t[e])return!1;return!0}function le(r,t){for(let e=0,n=t.length;e<n;e++)r[e]=t[e]}function Ps(r,t){let e=Gl[t];e===void 0&&(e=new Int32Array(t),Gl[t]=e);for(let n=0;n!==t;++n)e[n]=r.allocateTextureUnit();return e}function Im(r,t){const e=this.cache;e[0]!==t&&(r.uniform1f(this.addr,t),e[0]=t)}function Nm(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(r.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(oe(e,t))return;r.uniform2fv(this.addr,t),le(e,t)}}function Om(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(r.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(r.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(oe(e,t))return;r.uniform3fv(this.addr,t),le(e,t)}}function Fm(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(r.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(oe(e,t))return;r.uniform4fv(this.addr,t),le(e,t)}}function Bm(r,t){const e=this.cache,n=t.elements;if(n===void 0){if(oe(e,t))return;r.uniformMatrix2fv(this.addr,!1,t),le(e,t)}else{if(oe(e,n))return;Vl.set(n),r.uniformMatrix2fv(this.addr,!1,Vl),le(e,n)}}function zm(r,t){const e=this.cache,n=t.elements;if(n===void 0){if(oe(e,t))return;r.uniformMatrix3fv(this.addr,!1,t),le(e,t)}else{if(oe(e,n))return;kl.set(n),r.uniformMatrix3fv(this.addr,!1,kl),le(e,n)}}function Gm(r,t){const e=this.cache,n=t.elements;if(n===void 0){if(oe(e,t))return;r.uniformMatrix4fv(this.addr,!1,t),le(e,t)}else{if(oe(e,n))return;Hl.set(n),r.uniformMatrix4fv(this.addr,!1,Hl),le(e,n)}}function Hm(r,t){const e=this.cache;e[0]!==t&&(r.uniform1i(this.addr,t),e[0]=t)}function km(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(r.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(oe(e,t))return;r.uniform2iv(this.addr,t),le(e,t)}}function Vm(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(r.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(oe(e,t))return;r.uniform3iv(this.addr,t),le(e,t)}}function Wm(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(r.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(oe(e,t))return;r.uniform4iv(this.addr,t),le(e,t)}}function Xm(r,t){const e=this.cache;e[0]!==t&&(r.uniform1ui(this.addr,t),e[0]=t)}function qm(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(r.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(oe(e,t))return;r.uniform2uiv(this.addr,t),le(e,t)}}function Ym(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(r.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(oe(e,t))return;r.uniform3uiv(this.addr,t),le(e,t)}}function jm(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(r.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(oe(e,t))return;r.uniform4uiv(this.addr,t),le(e,t)}}function Km(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),e.setTexture2D(t||Zc,i)}function Zm(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),e.setTexture3D(t||Jc,i)}function $m(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),e.setTextureCube(t||Qc,i)}function Jm(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),e.setTexture2DArray(t||$c,i)}function Qm(r){switch(r){case 5126:return Im;case 35664:return Nm;case 35665:return Om;case 35666:return Fm;case 35674:return Bm;case 35675:return zm;case 35676:return Gm;case 5124:case 35670:return Hm;case 35667:case 35671:return km;case 35668:case 35672:return Vm;case 35669:case 35673:return Wm;case 5125:return Xm;case 36294:return qm;case 36295:return Ym;case 36296:return jm;case 35678:case 36198:case 36298:case 36306:case 35682:return Km;case 35679:case 36299:case 36307:return Zm;case 35680:case 36300:case 36308:case 36293:return $m;case 36289:case 36303:case 36311:case 36292:return Jm}}function t_(r,t){r.uniform1fv(this.addr,t)}function e_(r,t){const e=ur(t,this.size,2);r.uniform2fv(this.addr,e)}function n_(r,t){const e=ur(t,this.size,3);r.uniform3fv(this.addr,e)}function i_(r,t){const e=ur(t,this.size,4);r.uniform4fv(this.addr,e)}function r_(r,t){const e=ur(t,this.size,4);r.uniformMatrix2fv(this.addr,!1,e)}function s_(r,t){const e=ur(t,this.size,9);r.uniformMatrix3fv(this.addr,!1,e)}function a_(r,t){const e=ur(t,this.size,16);r.uniformMatrix4fv(this.addr,!1,e)}function o_(r,t){r.uniform1iv(this.addr,t)}function l_(r,t){r.uniform2iv(this.addr,t)}function c_(r,t){r.uniform3iv(this.addr,t)}function u_(r,t){r.uniform4iv(this.addr,t)}function h_(r,t){r.uniform1uiv(this.addr,t)}function f_(r,t){r.uniform2uiv(this.addr,t)}function d_(r,t){r.uniform3uiv(this.addr,t)}function p_(r,t){r.uniform4uiv(this.addr,t)}function m_(r,t,e){const n=this.cache,i=t.length,s=Ps(e,i);oe(n,s)||(r.uniform1iv(this.addr,s),le(n,s));for(let a=0;a!==i;++a)e.setTexture2D(t[a]||Zc,s[a])}function __(r,t,e){const n=this.cache,i=t.length,s=Ps(e,i);oe(n,s)||(r.uniform1iv(this.addr,s),le(n,s));for(let a=0;a!==i;++a)e.setTexture3D(t[a]||Jc,s[a])}function g_(r,t,e){const n=this.cache,i=t.length,s=Ps(e,i);oe(n,s)||(r.uniform1iv(this.addr,s),le(n,s));for(let a=0;a!==i;++a)e.setTextureCube(t[a]||Qc,s[a])}function v_(r,t,e){const n=this.cache,i=t.length,s=Ps(e,i);oe(n,s)||(r.uniform1iv(this.addr,s),le(n,s));for(let a=0;a!==i;++a)e.setTexture2DArray(t[a]||$c,s[a])}function x_(r){switch(r){case 5126:return t_;case 35664:return e_;case 35665:return n_;case 35666:return i_;case 35674:return r_;case 35675:return s_;case 35676:return a_;case 5124:case 35670:return o_;case 35667:case 35671:return l_;case 35668:case 35672:return c_;case 35669:case 35673:return u_;case 5125:return h_;case 36294:return f_;case 36295:return d_;case 36296:return p_;case 35678:case 36198:case 36298:case 36306:case 35682:return m_;case 35679:case 36299:case 36307:return __;case 35680:case 36300:case 36308:case 36293:return g_;case 36289:case 36303:case 36311:case 36292:return v_}}class M_{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.setValue=Qm(e.type)}}class S_{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.size=e.size,this.setValue=x_(e.type)}}class E_{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const i=this.seq;for(let s=0,a=i.length;s!==a;++s){const o=i[s];o.setValue(t,e[o.id],n)}}}const ma=/(\w+)(\])?(\[|\.)?/g;function Wl(r,t){r.seq.push(t),r.map[t.id]=t}function y_(r,t,e){const n=r.name,i=n.length;for(ma.lastIndex=0;;){const s=ma.exec(n),a=ma.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===i){Wl(e,c===void 0?new M_(o,r,t):new S_(o,r,t));break}else{let f=e.map[o];f===void 0&&(f=new E_(o),Wl(e,f)),e=f}}}class fs{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const s=t.getActiveUniform(e,i),a=t.getUniformLocation(e,s.name);y_(s,a,this)}}setValue(t,e,n,i){const s=this.map[e];s!==void 0&&s.setValue(t,n,i)}setOptional(t,e,n){const i=e[n];i!==void 0&&this.setValue(t,n,i)}static upload(t,e,n,i){for(let s=0,a=e.length;s!==a;++s){const o=e[s],l=n[o.id];l.needsUpdate!==!1&&o.setValue(t,l.value,i)}}static seqWithValue(t,e){const n=[];for(let i=0,s=t.length;i!==s;++i){const a=t[i];a.id in e&&n.push(a)}return n}}function Xl(r,t,e){const n=r.createShader(t);return r.shaderSource(n,e),r.compileShader(n),n}let T_=0;function b_(r,t){const e=r.split(`
`),n=[],i=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let a=i;a<s;a++){const o=a+1;n.push(`${o===t?">":" "} ${o}: ${e[a]}`)}return n.join(`
`)}function A_(r){switch(r){case gn:return["Linear","( value )"];case Lt:return["sRGB","( value )"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",r),["Linear","( value )"]}}function ql(r,t,e){const n=r.getShaderParameter(t,r.COMPILE_STATUS),i=r.getShaderInfoLog(t).trim();if(n&&i==="")return"";const s=/ERROR: 0:(\d+)/.exec(i);if(s){const a=parseInt(s[1]);return e.toUpperCase()+`

`+i+`

`+b_(r.getShaderSource(t),a)}else return i}function w_(r,t){const e=A_(t);return"vec4 "+r+"( vec4 value ) { return LinearTo"+e[0]+e[1]+"; }"}function R_(r,t){let e;switch(t){case Nh:e="Linear";break;case Oh:e="Reinhard";break;case Fh:e="OptimizedCineon";break;case Bh:e="ACESFilmic";break;case zh:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+r+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}function C_(r){return[r.extensionDerivatives||r.envMapCubeUVHeight||r.bumpMap||r.normalMapTangentSpace||r.clearcoatNormalMap||r.flatShading||r.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(r.extensionFragDepth||r.logarithmicDepthBuffer)&&r.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",r.extensionDrawBuffers&&r.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(r.extensionShaderTextureLOD||r.envMap||r.transmission)&&r.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(xr).join(`
`)}function P_(r){const t=[];for(const e in r){const n=r[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function L_(r,t){const e={},n=r.getProgramParameter(t,r.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const s=r.getActiveAttrib(t,i),a=s.name;let o=1;s.type===r.FLOAT_MAT2&&(o=2),s.type===r.FLOAT_MAT3&&(o=3),s.type===r.FLOAT_MAT4&&(o=4),e[a]={type:s.type,location:r.getAttribLocation(t,a),locationSize:o}}return e}function xr(r){return r!==""}function Yl(r,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return r.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function jl(r,t){return r.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const D_=/^[ \t]*#include +<([\w\d./]+)>/gm;function za(r){return r.replace(D_,I_)}const U_=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function I_(r,t){let e=Pt[t];if(e===void 0){const n=U_.get(t);if(n!==void 0)e=Pt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return za(e)}const N_=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Kl(r){return r.replace(N_,O_)}function O_(r,t,e,n){let i="";for(let s=parseInt(t);s<parseInt(e);s++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return i}function Zl(r){let t="precision "+r.precision+` float;
precision `+r.precision+" int;";return r.precision==="highp"?t+=`
#define HIGH_PRECISION`:r.precision==="mediump"?t+=`
#define MEDIUM_PRECISION`:r.precision==="lowp"&&(t+=`
#define LOW_PRECISION`),t}function F_(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===yc?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===dh?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===An&&(t="SHADOWMAP_TYPE_VSM"),t}function B_(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case tr:case er:t="ENVMAP_TYPE_CUBE";break;case Rs:t="ENVMAP_TYPE_CUBE_UV";break}return t}function z_(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case er:t="ENVMAP_MODE_REFRACTION";break}return t}function G_(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case Ac:t="ENVMAP_BLENDING_MULTIPLY";break;case Uh:t="ENVMAP_BLENDING_MIX";break;case Ih:t="ENVMAP_BLENDING_ADD";break}return t}function H_(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function k_(r,t,e,n){const i=r.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=F_(e),c=B_(e),u=z_(e),f=G_(e),h=H_(e),m=e.isWebGL2?"":C_(e),g=P_(s),_=i.createProgram();let p,d,E=e.glslVersion?"#version "+e.glslVersion+`
...
*/var Ve={autoSleep:120,force3D:"auto",nullTargetWarn:1,units:{lineHeight:""}},rr={duration:.5,overwrite:!1,delay:0},uo,Me,Jt,Ke=1e8,Wt=1/Ke,Ga=Math.PI*2,bg=Ga/4,Ag=0,nu=Math.sqrt,wg=Math.cos,Rg=Math.sin,pe=function(t){return typeof t=="string"},Qt=function(t){return typeof t=="function"},Un=function(t){return typeof t=="number"},ho=function(t){return typeof t>"u"},vn=function(t){return typeof t=="object"},Le=function(t){return t!==!1},fo=function(){return typeof window<"u"},hs=function(t){return Qt(t)||pe(t)},iu=typeof ArrayBuffer=="function"&&ArrayBuffer.isView||function(){},Se=Array.isArray,Ha=/(?:-?\.?\d|\.)+/gi,ru=/[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g,Yi=/[-+=.]*\d+[.e-]*\d*[a-z%]*/g,Ma=/[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi,su=/[+-]=-?[.\d]+/,au=/[^,'"\[\]\s]+/gi,Cg=/^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i,jt,Ye,ka,po,We={},vs={},ou,lu=function(t){return(vs=yi(t,We))&&Ie},mo=function(t,e){return console.warn("Invalid property",t,"set to",e,"Missing plugin? gsap.registerPlugin()")},xs=function(t,e){return!e&&console.warn(t)},cu=function(t,e){return t&&(We[t]=e)&&vs&&(vs[t]=e)||We},Cr=function(){return 0},Pg={suppressEvents:!0,isStart:!0,kill:!1},ds={suppressEvents:!0,kill:!1},Lg={suppressEvents:!0},_o={},qn=[],Va={},uu,ze={},Sa={},ac=30,ps=[],go="",vo=function(t){var e=t[0],n,i;if(vn(e)||Qt(e)||(t=[t]),!(n=(e._gsap||{}).harness)){for(i=ps.length;i--&&!ps[i].targetTest(e););n=ps[i]}for(i=t.length;i--;)t[i]&&(t[i]._gsap||(t[i]._gsap=new Iu(t[i],n)))||t.splice(i,1);return t},_i=function(t){return t._gsap||vo(Ze(t))[0]._gsap},hu=function(t,e,n){return(n=t[e])&&Qt(n)?t[e]():ho(n)&&t.getAttribute&&t.getAttribute(e)||n},De=function(t,e){return(t=t.split(",")).forEach(e)||t},ee=function(t){return Math.round(t*1e5)/1e5||0},_e=function(t){return Math.round(t*1e7)/1e7||0},$i=function(t,e){var n=e.charAt(0),i=parseFloat(e.substr(2));return t=parseFloat(t),n==="+"?t+i:n==="-"?t-i:n==="*"?t*i:t/i},Dg=function(t,e){for(var n=e.length,i=0;t.indexOf(e[i])<0&&++i<n;);return i<n},Ms=function(){var t=qn.length,e=qn.slice(0),n,i;for(Va={},qn.length=0,n=0;n<t;n++)i=e[n],i&&i._lazy&&(i.render(i._lazy[0],i._lazy[1],!0)._lazy=0)},fu=function(t,e,n,i){qn.length&&!Me&&Ms(),t.render(e,n,i||Me&&e<0&&(t._initted||t._startAt)),qn.length&&!Me&&Ms()},du=function(t){var e=parseFloat(t);return(e||e===0)&&(t+"").match(au).length<2?e:pe(t)?t.trim():t},pu=function(t){return t},Je=function(t,e){for(var n in e)n in t||(t[n]=e[n]);return t},Ug=function(t){return function(e,n){for(var i in n)i in e||i==="duration"&&t||i==="ease"||(e[i]=n[i])}},yi=function(t,e){for(var n in e)t[n]=e[n];return t},oc=function r(t,e){for(var n in e)n!=="__proto__"&&n!=="constructor"&&n!=="prototype"&&(t[n]=vn(e[n])?r(t[n]||(t[n]={}),e[n]):e[n]);return t},Ss=function(t,e){var n={},i;for(i in t)i in e||(n[i]=t[i]);return n},yr=function(t){var e=t.parent||jt,n=t.keyframes?Ug(Se(t.keyframes)):Je;if(Le(t.inherit))for(;e;)n(t,e.vars.defaults),e=e.parent||e._dp;return t},Ig=function(t,e){for(var n=t.length,i=n===e.length;i&&n--&&t[n]===e[n];);return n<0},mu=function(t,e,n,i,s){n===void 0&&(n="_first"),i===void 0&&(i="_last");var a=t[i],o;if(s)for(o=e[s];a&&a[s]>o;)a=a._prev;return a?(e._next=a._next,a._next=e):(e._next=t[n],t[n]=e),e._next?e._next._prev=e:t[i]=e,e._prev=a,e.parent=e._dp=t,e},Ls=function(t,e,n,i){n===void 0&&(n="_first"),i===void 0&&(i="_last");var s=e._prev,a=e._next;s?s._next=a:t[n]===e&&(t[n]=a),a?a._prev=s:t[i]===e&&(t[i]=s),e._next=e._prev=e.parent=null},Kn=function(t,e){t.parent&&(!e||t.parent.autoRemoveChildren)&&t.parent.remove&&t.parent.remove(t),t._act=0},gi=function(t,e){if(t&&(!e||e._end>t._dur||e._start<0))for(var n=t;n;)n._dirty=1,n=n.parent;return t},Ng=function(t){for(var e=t.parent;e&&e.parent;)e._dirty=1,e.totalDuration(),e=e.parent;return t},Wa=function(t,e,n,i){return t._startAt&&(Me?t._startAt.revert(ds):t.vars.immediateRender&&!t.vars.autoRevert||t._startAt.render(e,!0,i))},Og=function r(t){return!t||t._ts&&r(t.parent)},lc=function(t){return t._repeat?sr(t._tTime,t=t.duration()+t._rDelay)*t:0},sr=function(t,e){var n=Math.floor(t/=e);return t&&n===t?n-1:n},Es=function(t,e){return(t-e._start)*e._ts+(e._ts>=0?0:e._dirty?e.totalDuration():e._tDur)},Ds=function(t){return t._end=_e(t._start+(t._tDur/Math.abs(t._ts||t._rts||Wt)||0))},Us=function(t,e){var n=t._dp;return n&&n.smoothChildTiming&&t._ts&&(t._start=_e(n._time-(t._ts>0?e/t._ts:((t._dirty?t.totalDuration():t._tDur)-e)/-t._ts)),Ds(t),n._dirty||gi(n,t)),t},_u=function(t,e){var n;if((e._time||!e._dur&&e._initted||e._start<t._time&&(e._dur||!e.add))&&(n=Es(t.rawTime(),e),(!e._dur||Gr(0,e.totalDuration(),n)-e._tTime>Wt)&&e.render(n,!0)),gi(t,e)._dp&&t._initted&&t._time>=t._dur&&t._ts){if(t._dur<t.duration())for(n=t;n._dp;)n.rawTime()>=0&&n.totalTime(n._tTime),n=n._dp;t._zTime=-Wt}},fn=function(t,e,n,i){return e.parent&&Kn(e),e._start=_e((Un(n)?n:n||t!==jt?qe(t,n,e):t._time)+e._delay),e._end=_e(e._start+(e.totalDuration()/Math.abs(e.timeScale())||0)),mu(t,e,"_first","_last",t._sort?"_start":0),Xa(e)||(t._recent=e),i||_u(t,e),t._ts<0&&Us(t,t._tTime),t},gu=function(t,e){return(We.ScrollTrigger||mo("scrollTrigger",e))&&We.ScrollTrigger.create(e,t)},vu=function(t,e,n,i,s){if(Mo(t,e,s),!t._initted)return 1;if(!n&&t._pt&&!Me&&(t._dur&&t.vars.lazy!==!1||!t._dur&&t.vars.lazy)&&uu!==He.frame)return qn.push(t),t._lazy=[s,i],1},Fg=function r(t){var e=t.parent;return e&&e._ts&&e._initted&&!e._lock&&(e.rawTime()<0||r(e))},Xa=function(t){var e=t.data;return e==="isFromStart"||e==="isStart"},Bg=function(t,e,n,i){var s=t.ratio,a=e<0||!e&&(!t._start&&Fg(t)&&!(!t._initted&&Xa(t))||(t._ts<0||t._dp._ts<0)&&!Xa(t))?0:1,o=t._rDelay,l=0,c,u,f;if(o&&t._repeat&&(l=Gr(0,t._tDur,e),u=sr(l,o),t._yoyo&&u&1&&(a=1-a),u!==sr(t._tTime,o)&&(s=1-a,t.vars.repeatRefresh&&t._initted&&t.invalidate())),a!==s||Me||i||t._zTime===Wt||!e&&t._zTime){if(!t._initted&&vu(t,e,i,n,l))return;for(f=t._zTime,t._zTime=e||(n?Wt:0),n||(n=e&&!f),t.ratio=a,t._from&&(a=1-a),t._time=0,t._tTime=l,c=t._pt;c;)c.r(a,c.d),c=c._next;e<0&&Wa(t,e,n,!0),t._onUpdate&&!n&&$e(t,"onUpdate"),l&&t._repeat&&!n&&t.parent&&$e(t,"onRepeat"),(e>=t._tDur||e<0)&&t.ratio===a&&(a&&Kn(t,1),!n&&!Me&&($e(t,a?"onComplete":"onReverseComplete",!0),t._prom&&t._prom()))}else t._zTime||(t._zTime=e)},zg=function(t,e,n){var i;if(n>e)for(i=t._first;i&&i._start<=n;){if(i.data==="isPause"&&i._start>e)return i;i=i._next}else for(i=t._last;i&&i._start>=n;){if(i.data==="isPause"&&i._start<e)return i;i=i._prev}},ar=function(t,e,n,i){var s=t._repeat,a=_e(e)||0,o=t._tTime/t._tDur;return o&&!i&&(t._time*=a/t._dur),t._dur=a,t._tDur=s?s<0?1e10:_e(a*(s+1)+t._rDelay*s):a,o>0&&!i&&Us(t,t._tTime=t._tDur*o),t.parent&&Ds(t),n||gi(t.parent,t),t},cc=function(t){return t instanceof Re?gi(t):ar(t,t._dur)},Gg={_start:0,endTime:Cr,totalDuration:Cr},qe=function r(t,e,n){var i=t.labels,s=t._recent||Gg,a=t.duration()>=Ke?s.endTime(!1):t._dur,o,l,c;return pe(e)&&(isNaN(e)||e in i)?(l=e.charAt(0),c=e.substr(-1)==="%",o=e.indexOf("="),l==="<"||l===">"?(o>=0&&(e=e.replace(/=/,"")),(l==="<"?s._start:s.endTime(s._repeat>=0))+(parseFloat(e.substr(1))||0)*(c?(o<0?s:n).totalDuration()/100:1)):o<0?(e in i||(i[e]=a),i[e]):(l=parseFloat(e.charAt(o-1)+e.substr(o+1)),c&&n&&(l=l/100*(Se(n)?n[0]:n).totalDuration()),o>1?r(t,e.substr(0,o-1),n)+l:a+l)):e==null?a:+e},Tr=function(t,e,n){var i=Un(e[1]),s=(i?2:1)+(t<2?0:1),a=e[s],o,l;if(i&&(a.duration=e[1]),a.parent=n,t){for(o=a,l=n;l&&!("immediateRender"in o);)o=l.vars.defaults||{},l=Le(l.vars.inherit)&&l.parent;a.immediateRender=Le(o.immediateRender),t<2?a.runBackwards=1:a.startAt=e[s-1]}return new re(e[0],a,e[s+1])},Jn=function(t,e){return t||t===0?e(t):e},Gr=function(t,e,n){return n<t?t:n>e?e:n},xe=function(t,e){return!pe(t)||!(e=Cg.exec(t))?"":e[1]},Hg=function(t,e,n){return Jn(n,function(i){return Gr(t,e,i)})},qa=[].slice,xu=function(t,e){return t&&vn(t)&&"length"in t&&(!e&&!t.length||t.length-1 in t&&vn(t[0]))&&!t.nodeType&&t!==Ye},kg=function(t,e,n){return n===void 0&&(n=[]),t.forEach(function(i){var s;return pe(i)&&!e||xu(i,1)?(s=n).push.apply(s,Ze(i)):n.push(i)})||n},Ze=function(t,e,n){return Jt&&!e&&Jt.selector?Jt.selector(t):pe(t)&&!n&&(ka||!or())?qa.call((e||po).querySelectorAll(t),0):Se(t)?kg(t,n):xu(t)?qa.call(t,0):t?[t]:[]},Ya=function(t){return t=Ze(t)[0]||xs("Invalid scope")||{},function(e){var n=t.current||t.nativeElement||t;return Ze(e,n.querySelectorAll?n:n===t?xs("Invalid scope")||po.createElement("div"):t)}},Mu=function(t){return t.sort(function(){return .5-Math.random()})},Su=function(t){if(Qt(t))return t;var e=vn(t)?t:{each:t},n=vi(e.ease),i=e.from||0,s=parseFloat(e.base)||0,a={},o=i>0&&i<1,l=isNaN(i)||o,c=e.axis,u=i,f=i;return pe(i)?u=f={center:.5,edges:.5,end:1}[i]||0:!o&&l&&(u=i[0],f=i[1]),function(h,m,g){var _=(g||e).length,p=a[_],d,E,x,S,M,w,A,L,v;if(!p){if(v=e.grid==="auto"?0:(e.grid||[1,Ke])[1],!v){for(A=-Ke;A<(A=g[v++].getBoundingClientRect().left)&&v<_;);v--}for(p=a[_]=[],d=l?Math.min(v,_)*u-.5:i%v,E=v===Ke?0:l?_*f/v-.5:i/v|0,A=0,L=Ke,w=0;w<_;w++)x=w%v-d,S=E-(w/v|0),p[w]=M=c?Math.abs(c==="y"?S:x):nu(x*x+S*S),M>A&&(A=M),M<L&&(L=M);i==="random"&&Mu(p),p.max=A-L,p.min=L,p.v=_=(parseFloat(e.amount)||parseFloat(e.each)*(v>_?_-1:c?c==="y"?_/v:v:Math.max(v,_/v))||0)*(i==="edges"?-1:1),p.b=_<0?s-_:s,p.u=xe(e.amount||e.each)||0,n=n&&_<0?Lu(n):n}return _=(p[h]-p.min)/p.max||0,_e(p.b+(n?n(_):_)*p.v)+p.u}},ja=function(t){var e=Math.pow(10,((t+"").split(".")[1]||"").length);return function(n){var i=_e(Math.round(parseFloat(n)/t)*t*e);return(i-i%1)/e+(Un(n)?0:xe(n))}},Eu=function(t,e){var n=Se(t),i,s;return!n&&vn(t)&&(i=n=t.radius||Ke,t.values?(t=Ze(t.values),(s=!Un(t[0]))&&(i*=i)):t=ja(t.increment)),Jn(e,n?Qt(t)?function(a){return s=t(a),Math.abs(s-a)<=i?s:a}:function(a){for(var o=parseFloat(s?a.x:a),l=parseFloat(s?a.y:0),c=Ke,u=0,f=t.length,h,m;f--;)s?(h=t[f].x-o,m=t[f].y-l,h=h*h+m*m):h=Math.abs(t[f]-o),h<c&&(c=h,u=f);return u=!i||c<=i?t[u]:a,s||u===a||Un(a)?u:u+xe(a)}:ja(t))},yu=function(t,e,n,i){return Jn(Se(t)?!e:n===!0?!!(n=0):!i,function(){return Se(t)?t[~~(Math.random()*t.length)]:(n=n||1e-5)&&(i=n<1?Math.pow(10,(n+"").length-2):1)&&Math.floor(Math.round((t-n/2+Math.random()*(e-t+n*.99))/n)*n*i)/i})},Vg=function(){for(var t=arguments.length,e=new Array(t),n=0;n<t;n++)e[n]=arguments[n];return function(i){return e.reduce(function(s,a){return a(s)},i)}},Wg=function(t,e){return function(n){return t(parseFloat(n))+(e||xe(n))}},Xg=function(t,e,n){return bu(t,e,0,1,n)},Tu=function(t,e,n){return Jn(n,function(i){return t[~~e(i)]})},qg=function r(t,e,n){var i=e-t;return Se(t)?Tu(t,r(0,t.length),e):Jn(n,function(s){return(i+(s-t)%i)%i+t})},Yg=function r(t,e,n){var i=e-t,s=i*2;return Se(t)?Tu(t,r(0,t.length-1),e):Jn(n,function(a){return a=(s+(a-t)%s)%s||0,t+(a>i?s-a:a)})},Pr=function(t){for(var e=0,n="",i,s,a,o;~(i=t.indexOf("random(",e));)a=t.indexOf(")",i),o=t.charAt(i+7)==="[",s=t.substr(i+7,a-i-7).match(o?au:Ha),n+=t.substr(e,i-e)+yu(o?s:+s[0],o?0:+s[1],+s[2]||1e-5),e=a+1;return n+t.substr(e,t.length-e)},bu=function(t,e,n,i,s){var a=e-t,o=i-n;return Jn(s,function(l){return n+((l-t)/a*o||0)})},jg=function r(t,e,n,i){var s=isNaN(t+e)?0:function(m){return(1-m)*t+m*e};if(!s){var a=pe(t),o={},l,c,u,f,h;if(n===!0&&(i=1)&&(n=null),a)t={p:t},e={p:e};else if(Se(t)&&!Se(e)){for(u=[],f=t.length,h=f-2,c=1;c<f;c++)u.push(r(t[c-1],t[c]));f--,s=function(g){g*=f;var _=Math.min(h,~~g);return u[_](g-_)},n=e}else i||(t=yi(Se(t)?[]:{},t));if(!u){for(l in e)xo.call(o,t,l,"get",e[l]);s=function(g){return yo(g,o)||(a?t.p:t)}}}return Jn(n,s)},uc=function(t,e,n){var i=t.labels,s=Ke,a,o,l;for(a in i)o=i[a]-e,o<0==!!n&&o&&s>(o=Math.abs(o))&&(l=a,s=o);return l},$e=function(t,e,n){var i=t.vars,s=i[e],a=Jt,o=t._ctx,l,c,u;if(s)return l=i[e+"Params"],c=i.callbackScope||t,n&&qn.length&&Ms(),o&&(Jt=o),u=l?s.apply(c,l):s.call(c),Jt=a,u},Mr=function(t){return Kn(t),t.scrollTrigger&&t.scrollTrigger.kill(!!Me),t.progress()<1&&$e(t,"onInterrupt"),t},ji,Au=[],wu=function(t){if(fo()&&t){t=!t.name&&t.default||t;var e=t.name,n=Qt(t),i=e&&!n&&t.init?function(){this._props=[]}:t,s={init:Cr,render:yo,add:xo,kill:u0,modifier:c0,rawVars:0},a={targetTest:0,get:0,getSetter:Eo,aliases:{},register:0};if(or(),t!==i){if(ze[e])return;Je(i,Je(Ss(t,s),a)),yi(i.prototype,yi(s,Ss(t,a))),ze[i.prop=e]=i,t.targetTest&&(ps.push(i),_o[e]=1),e=(e==="css"?"CSS":e.charAt(0).toUpperCase()+e.substr(1))+"Plugin"}cu(e,i),t.register&&t.register(Ie,i,Ue)}else t&&Au.push(t)},Vt=255,Sr={aqua:[0,Vt,Vt],lime:[0,Vt,0],silver:[192,192,192],black:[0,0,0],maroon:[128,0,0],teal:[0,128,128],blue:[0,0,Vt],navy:[0,0,128],white:[Vt,Vt,Vt],olive:[128,128,0],yellow:[Vt,Vt,0],orange:[Vt,165,0],gray:[128,128,128],purple:[128,0,128],green:[0,128,0],red:[Vt,0,0],pink:[Vt,192,203],cyan:[0,Vt,Vt],transparent:[Vt,Vt,Vt,0]},Ea=function(t,e,n){return t+=t<0?1:t>1?-1:0,(t*6<1?e+(n-e)*t*6:t<.5?n:t*3<2?e+(n-e)*(2/3-t)*6:e)*Vt+.5|0},Ru=function(t,e,n){var i=t?Un(t)?[t>>16,t>>8&Vt,t&Vt]:0:Sr.black,s,a,o,l,c,u,f,h,m,g;if(!i){if(t.substr(-1)===","&&(t=t.substr(0,t.length-1)),Sr[t])i=Sr[t];else if(t.charAt(0)==="#"){if(t.length<6&&(s=t.charAt(1),a=t.charAt(2),o=t.charAt(3),t="#"+s+s+a+a+o+o+(t.length===5?t.charAt(4)+t.charAt(4):"")),t.length===9)return i=parseInt(t.substr(1,6),16),[i>>16,i>>8&Vt,i&Vt,parseInt(t.substr(7),16)/255];t=parseInt(t.substr(1),16),i=[t>>16,t>>8&Vt,t&Vt]}else if(t.substr(0,3)==="hsl"){if(i=g=t.match(Ha),!e)l=+i[0]%360/360,c=+i[1]/100,u=+i[2]/100,a=u<=.5?u*(c+1):u+c-u*c,s=u*2-a,i.length>3&&(i[3]*=1),i[0]=Ea(l+1/3,s,a),i[1]=Ea(l,s,a),i[2]=Ea(l-1/3,s,a);else if(~t.indexOf("="))return i=t.match(ru),n&&i.length<4&&(i[3]=1),i}else i=t.match(Ha)||Sr.transparent;i=i.map(Number)}return e&&!g&&(s=i[0]/Vt,a=i[1]/Vt,o=i[2]/Vt,f=Math.max(s,a,o),h=Math.min(s,a,o),u=(f+h)/2,f===h?l=c=0:(m=f-h,c=u>.5?m/(2-f-h):m/(f+h),l=f===s?(a-o)/m+(a<o?6:0):f===a?(o-s)/m+2:(s-a)/m+4,l*=60),i[0]=~~(l+.5),i[1]=~~(c*100+.5),i[2]=~~(u*100+.5)),n&&i.length<4&&(i[3]=1),i},Cu=function(t){var e=[],n=[],i=-1;return t.split(Yn).forEach(function(s){var a=s.match(Yi)||[];e.push.apply(e,a),n.push(i+=a.length+1)}),e.c=n,e},hc=function(t,e,n){var i="",s=(t+i).match(Yn),a=e?"hsla(":"rgba(",o=0,l,c,u,f;if(!s)return t;if(s=s.map(function(h){return(h=Ru(h,e,1))&&a+(e?h[0]+","+h[1]+"%,"+h[2]+"%,"+h[3]:h.join(","))+")"}),n&&(u=Cu(t),l=n.c,l.join(i)!==u.c.join(i)))for(c=t.replace(Yn,"1").split(Yi),f=c.length-1;o<f;o++)i+=c[o]+(~l.indexOf(o)?s.shift()||a+"0,0,0,0)":(u.length?u:s.length?s:n).shift());if(!c)for(c=t.split(Yn),f=c.length-1;o<f;o++)i+=c[o]+s[o];return i+c[f]},Yn=function(){var r="(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3,4}){1,2}\\b",t;for(t in Sr)r+="|"+t+"\\b";return new RegExp(r+")","gi")}(),Kg=/hsl[a]?\(/,Pu=function(t){var e=t.join(" "),n;if(Yn.lastIndex=0,Yn.test(e))return n=Kg.test(e),t[1]=hc(t[1],n),t[0]=hc(t[0],n,Cu(t[1])),!0},Lr,He=function(){var r=Date.now,t=500,e=33,n=r(),i=n,s=1e3/240,a=s,o=[],l,c,u,f,h,m,g=function _(p){var d=r()-i,E=p===!0,x,S,M,w;if(d>t&&(n+=d-e),i+=d,M=i-n,x=M-a,(x>0||E)&&(w=++f.frame,h=M-f.time*1e3,f.time=M=M/1e3,a+=x+(x>=s?4:s-x),S=1),E||(l=c(_)),S)for(m=0;m<o.length;m++)o[m](M,h,w,p)};return f={time:0,frame:0,tick:function(){g(!0)},deltaRatio:function(p){return h/(1e3/(p||60))},wake:function(){ou&&(!ka&&fo()&&(Ye=ka=window,po=Ye.document||{},We.gsap=Ie,(Ye.gsapVersions||(Ye.gsapVersions=[])).push(Ie.version),lu(vs||Ye.GreenSockGlobals||!Ye.gsap&&Ye||{}),u=Ye.requestAnimationFrame,Au.forEach(wu)),l&&f.sleep(),c=u||function(p){return setTimeout(p,a-f.time*1e3+1|0)},Lr=1,g(2))},sleep:function(){(u?Ye.cancelAnimationFrame:clearTimeout)(l),Lr=0,c=Cr},lagSmoothing:function(p,d){t=p||1/0,e=Math.min(d||33,t)},fps:function(p){s=1e3/(p||240),a=f.time*1e3+s},add:function(p,d,E){var x=d?function(S,M,w,A){p(S,M,w,A),f.remove(x)}:p;return f.remove(p),o[E?"unshift":"push"](x),or(),x},remove:function(p,d){~(d=o.indexOf(p))&&o.splice(d,1)&&m>=d&&m--},_listeners:o},f}(),or=function(){return!Lr&&He.wake()},Ft={},Zg=/^[\d.\-M][\d.\-,\s]/,$g=/["']/g,Jg=function(t){for(var e={},n=t.substr(1,t.length-3).split(":"),i=n[0],s=1,a=n.length,o,l,c;s<a;s++)l=n[s],o=s!==a-1?l.lastIndexOf(","):l.length,c=l.substr(0,o),e[i]=isNaN(c)?c.replace($g,"").trim():+c,i=l.substr(o+1).trim();return e},Qg=function(t){var e=t.indexOf("(")+1,n=t.indexOf(")"),i=t.indexOf("(",e);return t.substring(e,~i&&i<n?t.indexOf(")",n+1):n)},t0=function(t){var e=(t+"").split("("),n=Ft[e[0]];return n&&e.length>1&&n.config?n.config.apply(null,~t.indexOf("{")?[Jg(e[1])]:Qg(t).split(",").map(du)):Ft._CE&&Zg.test(t)?Ft._CE("",t):n},Lu=function(t){return function(e){return 1-t(1-e)}},Du=function r(t,e){for(var n=t._first,i;n;)n instanceof Re?r(n,e):n.vars.yoyoEase&&(!n._yoyo||!n._repeat)&&n._yoyo!==e&&(n.timeline?r(n.timeline,e):(i=n._ease,n._ease=n._yEase,n._yEase=i,n._yoyo=e)),n=n._next},vi=function(t,e){return t&&(Qt(t)?t:Ft[t]||t0(t))||e},bi=function(t,e,n,i){n===void 0&&(n=function(l){return 1-e(1-l)}),i===void 0&&(i=function(l){return l<.5?e(l*2)/2:1-e((1-l)*2)/2});var s={easeIn:e,easeOut:n,easeInOut:i},a;return De(t,function(o){Ft[o]=We[o]=s,Ft[a=o.toLowerCase()]=n;for(var l in s)Ft[a+(l==="easeIn"?".in":l==="easeOut"?".out":".inOut")]=Ft[o+"."+l]=s[l]}),s},Uu=function(t){return function(e){return e<.5?(1-t(1-e*2))/2:.5+t((e-.5)*2)/2}},ya=function r(t,e,n){var i=e>=1?e:1,s=(n||(t?.3:.45))/(e<1?e:1),a=s/Ga*(Math.asin(1/i)||0),o=function(u){return u===1?1:i*Math.pow(2,-10*u)*Rg((u-a)*s)+1},l=t==="out"?o:t==="in"?function(c){return 1-o(1-c)}:Uu(o);return s=Ga/s,l.config=function(c,u){return r(t,c,u)},l},Ta=function r(t,e){e===void 0&&(e=1.70158);var n=function(a){return a?--a*a*((e+1)*a+e)+1:0},i=t==="out"?n:t==="in"?function(s){return 1-n(1-s)}:Uu(n);return i.config=function(s){return r(t,s)},i};De("Linear,Quad,Cubic,Quart,Quint,Strong",function(r,t){var e=t<5?t+1:t;bi(r+",Power"+(e-1),t?function(n){return Math.pow(n,e)}:function(n){return n},function(n){return 1-Math.pow(1-n,e)},function(n){return n<.5?Math.pow(n*2,e)/2:1-Math.pow((1-n)*2,e)/2})});Ft.Linear.easeNone=Ft.none=Ft.Linear.easeIn;bi("Elastic",ya("in"),ya("out"),ya());(function(r,t){var e=1/t,n=2*e,i=2.5*e,s=function(o){return o<e?r*o*o:o<n?r*Math.pow(o-1.5/t,2)+.75:o<i?r*(o-=2.25/t)*o+.9375:r*Math.pow(o-2.625/t,2)+.984375};bi("Bounce",function(a){return 1-s(1-a)},s)})(7.5625,2.75);bi("Expo",function(r){return r?Math.pow(2,10*(r-1)):0});bi("Circ",function(r){return-(nu(1-r*r)-1)});bi("Sine",function(r){return r===1?1:-wg(r*bg)+1});bi("Back",Ta("in"),Ta("out"),Ta());Ft.SteppedEase=Ft.steps=We.SteppedEase={config:function(t,e){t===void 0&&(t=1);var n=1/t,i=t+(e?0:1),s=e?1:0,a=1-Wt;return function(o){return((i*Gr(0,a,o)|0)+s)*n}}};rr.ease=Ft["quad.out"];De("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt",function(r){return go+=r+","+r+"Params,"});var Iu=function(t,e){this.id=Ag++,t._gsap=this,this.target=t,this.harness=e,this.get=e?e.get:hu,this.set=e?e.getSetter:Eo},Dr=function(){function r(e){this.vars=e,this._delay=+e.delay||0,(this._repeat=e.repeat===1/0?-2:e.repeat||0)&&(this._rDelay=e.repeatDelay||0,this._yoyo=!!e.yoyo||!!e.yoyoEase),this._ts=1,ar(this,+e.duration,1,1),this.data=e.data,Jt&&(this._ctx=Jt,Jt.data.push(this)),Lr||He.wake()}var t=r.prototype;return t.delay=function(n){return n||n===0?(this.parent&&this.parent.smoothChildTiming&&this.startTime(this._start+n-this._delay),this._delay=n,this):this._delay},t.duration=function(n){return arguments.length?this.totalDuration(this._repeat>0?n+(n+this._rDelay)*this._repeat:n):this.totalDuration()&&this._dur},t.totalDuration=function(n){return arguments.length?(this._dirty=0,ar(this,this._repeat<0?n:(n-this._repeat*this._rDelay)/(this._repeat+1))):this._tDur},t.totalTime=function(n,i){if(or(),!arguments.length)return this._tTime;var s=this._dp;if(s&&s.smoothChildTiming&&this._ts){for(Us(this,n),!s._dp||s.parent||_u(s,this);s&&s.parent;)s.parent._time!==s._start+(s._ts>=0?s._tTime/s._ts:(s.totalDuration()-s._tTime)/-s._ts)&&s.totalTime(s._tTime,!0),s=s.parent;!this.parent&&this._dp.autoRemoveChildren&&(this._ts>0&&n<this._tDur||this._ts<0&&n>0||!this._tDur&&!n)&&fn(this._dp,this,this._start-this._delay)}return(this._tTime!==n||!this._dur&&!i||this._initted&&Math.abs(this._zTime)===Wt||!n&&!this._initted&&(this.add||this._ptLookup))&&(this._ts||(this._pTime=n),fu(this,n,i)),this},t.time=function(n,i){return arguments.length?this.totalTime(Math.min(this.totalDuration(),n+lc(this))%(this._dur+this._rDelay)||(n?this._dur:0),i):this._time},t.totalProgress=function(n,i){return arguments.length?this.totalTime(this.totalDuration()*n,i):this.totalDuration()?Math.min(1,this._tTime/this._tDur):this.ratio},t.progress=function(n,i){return arguments.length?this.totalTime(this.duration()*(this._yoyo&&!(this.iteration()&1)?1-n:n)+lc(this),i):this.duration()?Math.min(1,this._time/this._dur):this.ratio},t.iteration=function(n,i){var s=this.duration()+this._rDelay;return arguments.length?this.totalTime(this._time+(n-1)*s,i):this._repeat?sr(this._tTime,s)+1:1},t.timeScale=function(n){if(!arguments.length)return this._rts===-Wt?0:this._rts;if(this._rts===n)return this;var i=this.parent&&this._ts?Es(this.parent._time,this):this._tTime;return this._rts=+n||0,this._ts=this._ps||n===-Wt?0:this._rts,this.totalTime(Gr(-Math.abs(this._delay),this._tDur,i),!0),Ds(this),Ng(this)},t.paused=function(n){return arguments.length?(this._ps!==n&&(this._ps=n,n?(this._pTime=this._tTime||Math.max(-this._delay,this.rawTime()),this._ts=this._act=0):(or(),this._ts=this._rts,this.totalTime(this.parent&&!this.parent.smoothChildTiming?this.rawTime():this._tTime||this._pTime,this.progress()===1&&Math.abs(this._zTime)!==Wt&&(this._tTime-=Wt)))),this):this._ps},t.startTime=function(n){if(arguments.length){this._start=n;var i=this.parent||this._dp;return i&&(i._sort||!this.parent)&&fn(i,this,n-this._delay),this}return this._start},t.endTime=function(n){return this._start+(Le(n)?this.totalDuration():this.duration())/Math.abs(this._ts||1)},t.rawTime=function(n){var i=this.parent||this._dp;return i?n&&(!this._ts||this._repeat&&this._time&&this.totalProgress()<1)?this._tTime%(this._dur+this._rDelay):this._ts?Es(i.rawTime(n),this):this._tTime:this._tTime},t.revert=function(n){n===void 0&&(n=Lg);var i=Me;return Me=n,(this._initted||this._startAt)&&(this.timeline&&this.timeline.revert(n),this.totalTime(-.01,n.suppressEvents)),this.data!=="nested"&&n.kill!==!1&&this.kill(),Me=i,this},t.globalTime=function(n){for(var i=this,s=arguments.length?n:i.rawTime();i;)s=i._start+s/(i._ts||1),i=i._dp;return!this.parent&&this._sat?this._sat.vars.immediateRender?-1/0:this._sat.globalTime(n):s},t.repeat=function(n){return arguments.length?(this._repeat=n===1/0?-2:n,cc(this)):this._repeat===-2?1/0:this._repeat},t.repeatDelay=function(n){if(arguments.length){var i=this._time;return this._rDelay=n,cc(this),i?this.time(i):this}return this._rDelay},t.yoyo=function(n){return arguments.length?(this._yoyo=n,this):this._yoyo},t.seek=function(n,i){return this.totalTime(qe(this,n),Le(i))},t.restart=function(n,i){return this.play().totalTime(n?-this._delay:0,Le(i))},t.play=function(n,i){return n!=null&&this.seek(n,i),this.reversed(!1).paused(!1)},t.reverse=function(n,i){return n!=null&&this.seek(n||this.totalDuration(),i),this.reversed(!0).paused(!1)},t.pause=function(n,i){return n!=null&&this.seek(n,i),this.paused(!0)},t.resume=function(){return this.paused(!1)},t.reversed=function(n){return arguments.length?(!!n!==this.reversed()&&this.timeScale(-this._rts||(n?-Wt:0)),this):this._rts<0},t.invalidate=function(){return this._initted=this._act=0,this._zTime=-Wt,this},t.isActive=function(){var n=this.parent||this._dp,i=this._start,s;return!!(!n||this._ts&&this._initted&&n.isActive()&&(s=n.rawTime(!0))>=i&&s<this.endTime(!0)-Wt)},t.eventCallback=function(n,i,s){var a=this.vars;return arguments.length>1?(i?(a[n]=i,s&&(a[n+"Params"]=s),n==="onUpdate"&&(this._onUpdate=i)):delete a[n],this):a[n]},t.then=function(n){var i=this;return new Promise(function(s){var a=Qt(n)?n:pu,o=function(){var c=i.then;i.then=null,Qt(a)&&(a=a(i))&&(a.then||a===i)&&(i.then=c),s(a),i.then=c};i._initted&&i.totalProgress()===1&&i._ts>=0||!i._tTime&&i._ts<0?o():i._prom=o})},t.kill=function(){Mr(this)},r}();Je(Dr.prototype,{_time:0,_start:0,_end:0,_tTime:0,_tDur:0,_dirty:0,_repeat:0,_yoyo:!1,parent:null,_initted:!1,_rDelay:0,_ts:1,_dp:0,ratio:0,_zTime:-Wt,_prom:0,_ps:!1,_rts:1});var Re=function(r){eu(t,r);function t(n,i){var s;return n===void 0&&(n={}),s=r.call(this,n)||this,s.labels={},s.smoothChildTiming=!!n.smoothChildTiming,s.autoRemoveChildren=!!n.autoRemoveChildren,s._sort=Le(n.sortChildren),jt&&fn(n.parent||jt,wn(s),i),n.reversed&&s.reverse(),n.paused&&s.paused(!0),n.scrollTrigger&&gu(wn(s),n.scrollTrigger),s}var e=t.prototype;return e.to=function(i,s,a){return Tr(0,arguments,this),this},e.from=function(i,s,a){return Tr(1,arguments,this),this},e.fromTo=function(i,s,a,o){return Tr(2,arguments,this),this},e.set=function(i,s,a){return s.duration=0,s.parent=this,yr(s).repeatDelay||(s.repeat=0),s.immediateRender=!!s.immediateRender,new re(i,s,qe(this,a),1),this},e.call=function(i,s,a){return fn(this,re.delayedCall(0,i,s),a)},e.staggerTo=function(i,s,a,o,l,c,u){return a.duration=s,a.stagger=a.stagger||o,a.onComplete=c,a.onCompleteParams=u,a.parent=this,new re(i,a,qe(this,l)),this},e.staggerFrom=function(i,s,a,o,l,c,u){return a.runBackwards=1,yr(a).immediateRender=Le(a.immediateRender),this.staggerTo(i,s,a,o,l,c,u)},e.staggerFromTo=function(i,s,a,o,l,c,u,f){return o.startAt=a,yr(o).immediateRender=Le(o.immediateRender),this.staggerTo(i,s,o,l,c,u,f)},e.render=function(i,s,a){var o=this._time,l=this._dirty?this.totalDuration():this._tDur,c=this._dur,u=i<=0?0:_e(i),f=this._zTime<0!=i<0&&(this._initted||!c),h,m,g,_,p,d,E,x,S,M,w,A;if(this!==jt&&u>l&&i>=0&&(u=l),u!==this._tTime||a||f){if(o!==this._time&&c&&(u+=this._time-o,i+=this._time-o),h=u,S=this._start,x=this._ts,d=!x,f&&(c||(o=this._zTime),(i||!s)&&(this._zTime=i)),this._repeat){if(w=this._yoyo,p=c+this._rDelay,this._repeat<-1&&i<0)return this.totalTime(p*100+i,s,a);if(h=_e(u%p),u===l?(_=this._repeat,h=c):(_=~~(u/p),_&&_===u/p&&(h=c,_--),h>c&&(h=c)),M=sr(this._tTime,p),!o&&this._tTime&&M!==_&&this._tTime-M*p-this._dur<=0&&(M=_),w&&_&1&&(h=c-h,A=1),_!==M&&!this._lock){var L=w&&M&1,v=L===(w&&_&1);if(_<M&&(L=!L),o=L?0:u%c?c:u,this._lock=1,this.render(o||(A?0:_e(_*p)),s,!c)._lock=0,this._tTime=u,!s&&this.parent&&$e(this,"onRepeat"),this.vars.repeatRefresh&&!A&&(this.invalidate()._lock=1),o&&o!==this._time||d!==!this._ts||this.vars.onRepeat&&!this.parent&&!this._act)return this;if(c=this._dur,l=this._tDur,v&&(this._lock=2,o=L?c:-1e-4,this.render(o,!0),this.vars.repeatRefresh&&!A&&this.invalidate()),this._lock=0,!this._ts&&!d)return this;Du(this,A)}}if(this._hasPause&&!this._forcing&&this._lock<2&&(E=zg(this,_e(o),_e(h)),E&&(u-=h-(h=E._start))),this._tTime=u,this._time=h,this._act=!x,this._initted||(this._onUpdate=this.vars.onUpdate,this._initted=1,this._zTime=i,o=0),!o&&h&&!s&&!_&&($e(this,"onStart"),this._tTime!==u))return this;if(h>=o&&i>=0)for(m=this._first;m;){if(g=m._next,(m._act||h>=m._start)&&m._ts&&E!==m){if(m.parent!==this)return this.render(i,s,a);if(m.render(m._ts>0?(h-m._start)*m._ts:(m._dirty?m.totalDuration():m._tDur)+(h-m._start)*m._ts,s,a),h!==this._time||!this._ts&&!d){E=0,g&&(u+=this._zTime=-Wt);break}}m=g}else{m=this._last;for(var b=i<0?i:h;m;){if(g=m._prev,(m._act||b<=m._end)&&m._ts&&E!==m){if(m.parent!==this)return this.render(i,s,a);if(m.render(m._ts>0?(b-m._start)*m._ts:(m._dirty?m.totalDuration():m._tDur)+(b-m._start)*m._ts,s,a||Me&&(m._initted||m._startAt)),h!==this._time||!this._ts&&!d){E=0,g&&(u+=this._zTime=b?-Wt:Wt);break}}m=g}}if(E&&!s&&(this.pause(),E.render(h>=o?0:-Wt)._zTime=h>=o?1:-1,this._ts))return this._start=S,Ds(this),this.render(i,s,a);this._onUpdate&&!s&&$e(this,"onUpdate",!0),(u===l&&this._tTime>=this.totalDuration()||!u&&o)&&(S===this._start||Math.abs(x)!==Math.abs(this._ts))&&(this._lock||((i||!c)&&(u===l&&this._ts>0||!u&&this._ts<0)&&Kn(this,1),!s&&!(i<0&&!o)&&(u||o||!l)&&($e(this,u===l&&i>=0?"onComplete":"onReverseComplete",!0),this._prom&&!(u<l&&this.timeScale()>0)&&this._prom())))}return this},e.add=function(i,s){var a=this;if(Un(s)||(s=qe(this,s,i)),!(i instanceof Dr)){if(Se(i))return i.forEach(function(o){return a.add(o,s)}),this;if(pe(i))return this.addLabel(i,s);if(Qt(i))i=re.delayedCall(0,i);else return this}return this!==i?fn(this,i,s):this},e.getChildren=function(i,s,a,o){i===void 0&&(i=!0),s===void 0&&(s=!0),a===void 0&&(a=!0),o===void 0&&(o=-Ke);for(var l=[],c=this._first;c;)c._start>=o&&(c instanceof re?s&&l.push(c):(a&&l.push(c),i&&l.push.apply(l,c.getChildren(!0,s,a)))),c=c._next;return l},e.getById=function(i){for(var s=this.getChildren(1,1,1),a=s.length;a--;)if(s[a].vars.id===i)return s[a]},e.remove=function(i){return pe(i)?this.removeLabel(i):Qt(i)?this.killTweensOf(i):(Ls(this,i),i===this._recent&&(this._recent=this._last),gi(this))},e.totalTime=function(i,s){return arguments.length?(this._forcing=1,!this._dp&&this._ts&&(this._start=_e(He.time-(this._ts>0?i/this._ts:(this.totalDuration()-i)/-this._ts))),r.prototype.totalTime.call(this,i,s),this._forcing=0,this):this._tTime},e.addLabel=function(i,s){return this.labels[i]=qe(this,s),this},e.removeLabel=function(i){return delete this.labels[i],this},e.addPause=function(i,s,a){var o=re.delayedCall(0,s||Cr,a);return o.data="isPause",this._hasPause=1,fn(this,o,qe(this,i))},e.removePause=function(i){var s=this._first;for(i=qe(this,i);s;)s._start===i&&s.data==="isPause"&&Kn(s),s=s._next},e.killTweensOf=function(i,s,a){for(var o=this.getTweensOf(i,a),l=o.length;l--;)Hn!==o[l]&&o[l].kill(i,s);return this},e.getTweensOf=function(i,s){for(var a=[],o=Ze(i),l=this._first,c=Un(s),u;l;)l instanceof re?Dg(l._targets,o)&&(c?(!Hn||l._initted&&l._ts)&&l.globalTime(0)<=s&&l.globalTime(l.totalDuration())>s:!s||l.isActive())&&a.push(l):(u=l.getTweensOf(o,s)).length&&a.push.apply(a,u),l=l._next;return a},e.tweenTo=function(i,s){s=s||{};var a=this,o=qe(a,i),l=s,c=l.startAt,u=l.onStart,f=l.onStartParams,h=l.immediateRender,m,g=re.to(a,Je({ease:s.ease||"none",lazy:!1,immediateRender:!1,time:o,overwrite:"auto",duration:s.duration||Math.abs((o-(c&&"time"in c?c.time:a._time))/a.timeScale())||Wt,onStart:function(){if(a.pause(),!m){var p=s.duration||Math.abs((o-(c&&"time"in c?c.time:a._time))/a.timeScale());g._dur!==p&&ar(g,p,0,1).render(g._time,!0,!0),m=1}u&&u.apply(g,f||[])}},s));return h?g.render(0):g},e.tweenFromTo=function(i,s,a){return this.tweenTo(s,Je({startAt:{time:qe(this,i)}},a))},e.recent=function(){return this._recent},e.nextLabel=function(i){return i===void 0&&(i=this._time),uc(this,qe(this,i))},e.previousLabel=function(i){return i===void 0&&(i=this._time),uc(this,qe(this,i),1)},e.currentLabel=function(i){return arguments.length?this.seek(i,!0):this.previousLabel(this._time+Wt)},e.shiftChildren=function(i,s,a){a===void 0&&(a=0);for(var o=this._first,l=this.labels,c;o;)o._start>=a&&(o._start+=i,o._end+=i),o=o._next;if(s)for(c in l)l[c]>=a&&(l[c]+=i);return gi(this)},e.invalidate=function(i){var s=this._first;for(this._lock=0;s;)s.invalidate(i),s=s._next;return r.prototype.invalidate.call(this,i)},e.clear=function(i){i===void 0&&(i=!0);for(var s=this._first,a;s;)a=s._next,this.remove(s),s=a;return this._dp&&(this._time=this._tTime=this._pTime=0),i&&(this.labels={}),gi(this)},e.totalDuration=function(i){var s=0,a=this,o=a._last,l=Ke,c,u,f;if(arguments.length)return a.timeScale((a._repeat<0?a.duration():a.totalDuration())/(a.reversed()?-i:i));if(a._dirty){for(f=a.parent;o;)c=o._prev,o._dirty&&o.totalDuration(),u=o._start,u>l&&a._sort&&o._ts&&!a._lock?(a._lock=1,fn(a,o,u-o._delay,1)._lock=0):l=u,u<0&&o._ts&&(s-=u,(!f&&!a._dp||f&&f.smoothChildTiming)&&(a._start+=u/a._ts,a._time-=u,a._tTime-=u),a.shiftChildren(-u,!1,-1/0),l=0),o._end>s&&o._ts&&(s=o._end),o=c;ar(a,a===jt&&a._time>s?a._time:s,1,1),a._dirty=0}return a._tDur},t.updateRoot=function(i){if(jt._ts&&(fu(jt,Es(i,jt)),uu=He.frame),He.frame>=ac){ac+=Ve.autoSleep||120;var s=jt._first;if((!s||!s._ts)&&Ve.autoSleep&&He._listeners.length<2){for(;s&&!s._ts;)s=s._next;s||He.sleep()}}},t}(Dr);Je(Re.prototype,{_lock:0,_hasPause:0,_forcing:0});var e0=function(t,e,n,i,s,a,o){var l=new Ue(this._pt,t,e,0,1,Gu,null,s),c=0,u=0,f,h,m,g,_,p,d,E;for(l.b=n,l.e=i,n+="",i+="",(d=~i.indexOf("random("))&&(i=Pr(i)),a&&(E=[n,i],a(E,t,e),n=E[0],i=E[1]),h=n.match(Ma)||[];f=Ma.exec(i);)g=f[0],_=i.substring(c,f.index),m?m=(m+1)%5:_.substr(-5)==="rgba("&&(m=1),g!==h[u++]&&(p=parseFloat(h[u-1])||0,l._pt={_next:l._pt,p:_||u===1?_:",",s:p,c:g.charAt(1)==="="?$i(p,g)-p:parseFloat(g)-p,m:m&&m<4?Math.round:0},c=Ma.lastIndex);return l.c=c<i.length?i.substring(c,i.length):"",l.fp=o,(su.test(i)||d)&&(l.e=0),this._pt=l,l},xo=function(t,e,n,i,s,a,o,l,c,u){Qt(i)&&(i=i(s||0,t,a));var f=t[e],h=n!=="get"?n:Qt(f)?c?t[e.indexOf("set")||!Qt(t["get"+e.substr(3)])?e:"get"+e.substr(3)](c):t[e]():f,m=Qt(f)?c?a0:Bu:So,g;if(pe(i)&&(~i.indexOf("random(")&&(i=Pr(i)),i.charAt(1)==="="&&(g=$i(h,i)+(xe(h)||0),(g||g===0)&&(i=g))),!u||h!==i||Ka)return!isNaN(h*i)&&i!==""?(g=new Ue(this._pt,t,e,+h||0,i-(h||0),typeof f=="boolean"?l0:zu,0,m),c&&(g.fp=c),o&&g.modifier(o,this,t),this._pt=g):(!f&&!(e in t)&&mo(e,i),e0.call(this,t,e,h,i,m,l||Ve.stringFilter,c))},n0=function(t,e,n,i,s){if(Qt(t)&&(t=br(t,s,e,n,i)),!vn(t)||t.style&&t.nodeType||Se(t)||iu(t))return pe(t)?br(t,s,e,n,i):t;var a={},o;for(o in t)a[o]=br(t[o],s,e,n,i);return a},Nu=function(t,e,n,i,s,a){var o,l,c,u;if(ze[t]&&(o=new ze[t]).init(s,o.rawVars?e[t]:n0(e[t],i,s,a,n),n,i,a)!==!1&&(n._pt=l=new Ue(n._pt,s,t,0,1,o.render,o,0,o.priority),n!==ji))for(c=n._ptLookup[n._targets.indexOf(s)],u=o._props.length;u--;)c[o._props[u]]=l;return o},Hn,Ka,Mo=function r(t,e,n){var i=t.vars,s=i.ease,a=i.startAt,o=i.immediateRender,l=i.lazy,c=i.onUpdate,u=i.onUpdateParams,f=i.callbackScope,h=i.runBackwards,m=i.yoyoEase,g=i.keyframes,_=i.autoRevert,p=t._dur,d=t._startAt,E=t._targets,x=t.parent,S=x&&x.data==="nested"?x.vars.targets:E,M=t._overwrite==="auto"&&!uo,w=t.timeline,A,L,v,b,X,Z,U,F,B,K,G,W,Q;if(w&&(!g||!s)&&(s="none"),t._ease=vi(s,rr.ease),t._yEase=m?Lu(vi(m===!0?s:m,rr.ease)):0,m&&t._yoyo&&!t._repeat&&(m=t._yEase,t._yEase=t._ease,t._ease=m),t._from=!w&&!!i.runBackwards,!w||g&&!i.stagger){if(F=E[0]?_i(E[0]).harness:0,W=F&&i[F.prop],A=Ss(i,_o),d&&(d._zTime<0&&d.progress(1),e<0&&h&&o&&!_?d.render(-1,!0):d.revert(h&&p?ds:Pg),d._lazy=0),a){if(Kn(t._startAt=re.set(E,Je({data:"isStart",overwrite:!1,parent:x,immediateRender:!0,lazy:!d&&Le(l),startAt:null,delay:0,onUpdate:c,onUpdateParams:u,callbackScope:f,stagger:0},a))),t._startAt._dp=0,t._startAt._sat=t,e<0&&(Me||!o&&!_)&&t._startAt.revert(ds),o&&p&&e<=0&&n<=0){e&&(t._zTime=e);return}}else if(h&&p&&!d){if(e&&(o=!1),v=Je({overwrite:!1,data:"isFromStart",lazy:o&&!d&&Le(l),immediateRender:o,stagger:0,parent:x},A),W&&(v[F.prop]=W),Kn(t._startAt=re.set(E,v)),t._startAt._dp=0,t._startAt._sat=t,e<0&&(Me?t._startAt.revert(ds):t._startAt.render(-1,!0)),t._zTime=e,!o)r(t._startAt,Wt,Wt);else if(!e)return}for(t._pt=t._ptCache=0,l=p&&Le(l)||l&&!p,L=0;L<E.length;L++){if(X=E[L],U=X._gsap||vo(E)[L]._gsap,t._ptLookup[L]=K={},Va[U.id]&&qn.length&&Ms(),G=S===E?L:S.indexOf(X),F&&(B=new F).init(X,W||A,t,G,S)!==!1&&(t._pt=b=new Ue(t._pt,X,B.name,0,1,B.render,B,0,B.priority),B._props.forEach(function($){K[$]=b}),B.priority&&(Z=1)),!F||W)for(v in A)ze[v]&&(B=Nu(v,A,t,G,X,S))?B.priority&&(Z=1):K[v]=b=xo.call(t,X,v,"get",A[v],G,S,0,i.stringFilter);t._op&&t._op[L]&&t.kill(X,t._op[L]),M&&t._pt&&(Hn=t,jt.killTweensOf(X,K,t.globalTime(e)),Q=!t.parent,Hn=0),t._pt&&l&&(Va[U.id]=1)}Z&&Hu(t),t._onInit&&t._onInit(t)}t._onUpdate=c,t._initted=(!t._op||t._pt)&&!Q,g&&e<=0&&w.render(Ke,!0,!0)},i0=function(t,e,n,i,s,a,o){var l=(t._pt&&t._ptCache||(t._ptCache={}))[e],c,u,f,h;if(!l)for(l=t._ptCache[e]=[],f=t._ptLookup,h=t._targets.length;h--;){if(c=f[h][e],c&&c.d&&c.d._pt)for(c=c.d._pt;c&&c.p!==e&&c.fp!==e;)c=c._next;if(!c)return Ka=1,t.vars[e]="+=0",Mo(t,o),Ka=0,1;l.push(c)}for(h=l.length;h--;)u=l[h],c=u._pt||u,c.s=(i||i===0)&&!s?i:c.s+(i||0)+a*c.c,c.c=n-c.s,u.e&&(u.e=ee(n)+xe(u.e)),u.b&&(u.b=c.s+xe(u.b))},r0=function(t,e){var n=t[0]?_i(t[0]).harness:0,i=n&&n.aliases,s,a,o,l;if(!i)return e;s=yi({},e);for(a in i)if(a in s)for(l=i[a].split(","),o=l.length;o--;)s[l[o]]=s[a];return s},s0=function(t,e,n,i){var s=e.ease||i||"power1.inOut",a,o;if(Se(e))o=n[t]||(n[t]=[]),e.forEach(function(l,c){return o.push({t:c/(e.length-1)*100,v:l,e:s})});else for(a in e)o=n[a]||(n[a]=[]),a==="ease"||o.push({t:parseFloat(t),v:e[a],e:s})},br=function(t,e,n,i,s){return Qt(t)?t.call(e,n,i,s):pe(t)&&~t.indexOf("random(")?Pr(t):t},Ou=go+"repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert",Fu={};De(Ou+",id,stagger,delay,duration,paused,scrollTrigger",function(r){return Fu[r]=1});var re=function(r){eu(t,r);function t(n,i,s,a){var o;typeof i=="number"&&(s.duration=i,i=s,s=null),o=r.call(this,a?i:yr(i))||this;var l=o.vars,c=l.duration,u=l.delay,f=l.immediateRender,h=l.stagger,m=l.overwrite,g=l.keyframes,_=l.defaults,p=l.scrollTrigger,d=l.yoyoEase,E=i.parent||jt,x=(Se(n)||iu(n)?Un(n[0]):"length"in i)?[n]:Ze(n),S,M,w,A,L,v,b,X;if(o._targets=x.length?vo(x):xs("GSAP target "+n+" not found. https://greensock.com",!Ve.nullTargetWarn)||[],o._ptLookup=[],o._overwrite=m,g||h||hs(c)||hs(u)){if(i=o.vars,S=o.timeline=new Re({data:"nested",defaults:_||{},targets:E&&E.data==="nested"?E.vars.targets:x}),S.kill(),S.parent=S._dp=wn(o),S._start=0,h||hs(c)||hs(u)){if(A=x.length,b=h&&Su(h),vn(h))for(L in h)~Ou.indexOf(L)&&(X||(X={}),X[L]=h[L]);for(M=0;M<A;M++)w=Ss(i,Fu),w.stagger=0,d&&(w.yoyoEase=d),X&&yi(w,X),v=x[M],w.duration=+br(c,wn(o),M,v,x),w.delay=(+br(u,wn(o),M,v,x)||0)-o._delay,!h&&A===1&&w.delay&&(o._delay=u=w.delay,o._start+=u,w.delay=0),S.to(v,w,b?b(M,v,x):0),S._ease=Ft.none;S.duration()?c=u=0:o.timeline=0}else if(g){yr(Je(S.vars.defaults,{ease:"none"})),S._ease=vi(g.ease||i.ease||"none");var Z=0,U,F,B;if(Se(g))g.forEach(function(K){return S.to(x,K,">")}),S.duration();else{w={};for(L in g)L==="ease"||L==="easeEach"||s0(L,g[L],w,g.easeEach);for(L in w)for(U=w[L].sort(function(K,G){return K.t-G.t}),Z=0,M=0;M<U.length;M++)F=U[M],B={ease:F.e,duration:(F.t-(M?U[M-1].t:0))/100*c},B[L]=F.v,S.to(x,B,Z),Z+=B.duration;S.duration()<c&&S.to({},{duration:c-S.duration()})}}c||o.duration(c=S.duration())}else o.timeline=0;return m===!0&&!uo&&(Hn=wn(o),jt.killTweensOf(x),Hn=0),fn(E,wn(o),s),i.reversed&&o.reverse(),i.paused&&o.paused(!0),(f||!c&&!g&&o._start===_e(E._time)&&Le(f)&&Og(wn(o))&&E.data!=="nested")&&(o._tTime=-Wt,o.render(Math.max(0,-u)||0)),p&&gu(wn(o),p),o}var e=t.prototype;return e.render=function(i,s,a){var o=this._time,l=this._tDur,c=this._dur,u=i<0,f=i>l-Wt&&!u?l:i<Wt?0:i,h,m,g,_,p,d,E,x,S;if(!c)Bg(this,i,s,a);else if(f!==this._tTime||!i||a||!this._initted&&this._tTime||this._startAt&&this._zTime<0!==u){if(h=f,x=this.timeline,this._repeat){if(_=c+this._rDelay,this._repeat<-1&&u)return this.totalTime(_*100+i,s,a);if(h=_e(f%_),f===l?(g=this._repeat,h=c):(g=~~(f/_),g&&g===f/_&&(h=c,g--),h>c&&(h=c)),d=this._yoyo&&g&1,d&&(S=this._yEase,h=c-h),p=sr(this._tTime,_),h===o&&!a&&this._initted)return this._tTime=f,this;g!==p&&(x&&this._yEase&&Du(x,d),this.vars.repeatRefresh&&!d&&!this._lock&&(this._lock=a=1,this.render(_e(_*g),!0).invalidate()._lock=0))}if(!this._initted){if(vu(this,u?i:h,a,s,f))return this._tTime=0,this;if(o!==this._time)return this;if(c!==this._dur)return this.render(i,s,a)}if(this._tTime=f,this._time=h,!this._act&&this._ts&&(this._act=1,this._lazy=0),this.ratio=E=(S||this._ease)(h/c),this._from&&(this.ratio=E=1-E),h&&!o&&!s&&!g&&($e(this,"onStart"),this._tTime!==f))return this;for(m=this._pt;m;)m.r(E,m.d),m=m._next;x&&x.render(i<0?i:!h&&d?-Wt:x._dur*x._ease(h/this._dur),s,a)||this._startAt&&(this._zTime=i),this._onUpdate&&!s&&(u&&Wa(this,i,s,a),$e(this,"onUpdate")),this._repeat&&g!==p&&this.vars.onRepeat&&!s&&this.parent&&$e(this,"onRepeat"),(f===this._tDur||!f)&&this._tTime===f&&(u&&!this._onUpdate&&Wa(this,i,!0,!0),(i||!c)&&(f===this._tDur&&this._ts>0||!f&&this._ts<0)&&Kn(this,1),!s&&!(u&&!o)&&(f||o||d)&&($e(this,f===l?"onComplete":"onReverseComplete",!0),this._prom&&!(f<l&&this.timeScale()>0)&&this._prom()))}return this},e.targets=function(){return this._targets},e.invalidate=function(i){return(!i||!this.vars.runBackwards)&&(this._startAt=0),this._pt=this._op=this._onUpdate=this._lazy=this.ratio=0,this._ptLookup=[],this.timeline&&this.timeline.invalidate(i),r.prototype.invalidate.call(this,i)},e.resetTo=function(i,s,a,o){Lr||He.wake(),this._ts||this.play();var l=Math.min(this._dur,(this._dp._time-this._start)*this._ts),c;return this._initted||Mo(this,l),c=this._ease(l/this._dur),i0(this,i,s,a,o,c,l)?this.resetTo(i,s,a,o):(Us(this,0),this.parent||mu(this._dp,this,"_first","_last",this._dp._sort?"_start":0),this.render(0))},e.kill=function(i,s){if(s===void 0&&(s="all"),!i&&(!s||s==="all"))return this._lazy=this._pt=0,this.parent?Mr(this):this;if(this.timeline){var a=this.timeline.totalDuration();return this.timeline.killTweensOf(i,s,Hn&&Hn.vars.overwrite!==!0)._first||Mr(this),this.parent&&a!==this.timeline.totalDuration()&&ar(this,this._dur*this.timeline._tDur/a,0,1),this}var o=this._targets,l=i?Ze(i):o,c=this._ptLookup,u=this._pt,f,h,m,g,_,p,d;if((!s||s==="all")&&Ig(o,l))return s==="all"&&(this._pt=0),Mr(this);for(f=this._op=this._op||[],s!=="all"&&(pe(s)&&(_={},De(s,function(E){return _[E]=1}),s=_),s=r0(o,s)),d=o.length;d--;)if(~l.indexOf(o[d])){h=c[d],s==="all"?(f[d]=s,g=h,m={}):(m=f[d]=f[d]||{},g=s);for(_ in g)p=h&&h[_],p&&((!("kill"in p.d)||p.d.kill(_)===!0)&&Ls(this,p,"_pt"),delete h[_]),m!=="all"&&(m[_]=1)}return this._initted&&!this._pt&&u&&Mr(this),this},t.to=function(i,s){return new t(i,s,arguments[2])},t.from=function(i,s){return Tr(1,arguments)},t.delayedCall=function(i,s,a,o){return new t(s,0,{immediateRender:!1,lazy:!1,overwrite:!1,delay:i,onComplete:s,onReverseComplete:s,onCompleteParams:a,onReverseCompleteParams:a,callbackScope:o})},t.fromTo=function(i,s,a){return Tr(2,arguments)},t.set=function(i,s){return s.duration=0,s.repeatDelay||(s.repeat=0),new t(i,s)},t.killTweensOf=function(i,s,a){return jt.killTweensOf(i,s,a)},t}(Dr);Je(re.prototype,{_targets:[],_lazy:0,_startAt:0,_op:0,_onInit:0});De("staggerTo,staggerFrom,staggerFromTo",function(r){re[r]=function(){var t=new Re,e=qa.call(arguments,0);return e.splice(r==="staggerFromTo"?5:4,0,0),t[r].apply(t,e)}});var So=function(t,e,n){return t[e]=n},Bu=function(t,e,n){return t[e](n)},a0=function(t,e,n,i){return t[e](i.fp,n)},o0=function(t,e,n){return t.setAttribute(e,n)},Eo=function(t,e){return Qt(t[e])?Bu:ho(t[e])&&t.setAttribute?o0:So},zu=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e6)/1e6,e)},l0=function(t,e){return e.set(e.t,e.p,!!(e.s+e.c*t),e)},Gu=function(t,e){var n=e._pt,i="";if(!t&&e.b)i=e.b;else if(t===1&&e.e)i=e.e;else{for(;n;)i=n.p+(n.m?n.m(n.s+n.c*t):Math.round((n.s+n.c*t)*1e4)/1e4)+i,n=n._next;i+=e.c}e.set(e.t,e.p,i,e)},yo=function(t,e){for(var n=e._pt;n;)n.r(t,n.d),n=n._next},c0=function(t,e,n,i){for(var s=this._pt,a;s;)a=s._next,s.p===i&&s.modifier(t,e,n),s=a},u0=function(t){for(var e=this._pt,n,i;e;)i=e._next,e.p===t&&!e.op||e.op===t?Ls(this,e,"_pt"):e.dep||(n=1),e=i;return!n},h0=function(t,e,n,i){i.mSet(t,e,i.m.call(i.tween,n,i.mt),i)},Hu=function(t){for(var e=t._pt,n,i,s,a;e;){for(n=e._next,i=s;i&&i.pr>e.pr;)i=i._next;(e._prev=i?i._prev:a)?e._prev._next=e:s=e,(e._next=i)?i._prev=e:a=e,e=n}t._pt=s},Ue=function(){function r(e,n,i,s,a,o,l,c,u){this.t=n,this.s=s,this.c=a,this.p=i,this.r=o||zu,this.d=l||this,this.set=c||So,this.pr=u||0,this._next=e,e&&(e._prev=this)}var t=r.prototype;return t.modifier=function(n,i,s){this.mSet=this.mSet||this.set,this.set=h0,this.m=n,this.mt=s,this.tween=i},r}();De(go+"parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger",function(r){return _o[r]=1});We.TweenMax=We.TweenLite=re;We.TimelineLite=We.TimelineMax=Re;jt=new Re({sortChildren:!1,defaults:rr,autoRemoveChildren:!0,id:"root",smoothChildTiming:!0});Ve.stringFilter=Pu;var xi=[],ms={},f0=[],fc=0,d0=0,ba=function(t){return(ms[t]||f0).map(function(e){return e()})},Za=function(){var t=Date.now(),e=[];t-fc>2&&(ba("matchMediaInit"),xi.forEach(function(n){var i=n.queries,s=n.conditions,a,o,l,c;for(o in i)a=Ye.matchMedia(i[o]).matches,a&&(l=1),a!==s[o]&&(s[o]=a,c=1);c&&(n.revert(),l&&e.push(n))}),ba("matchMediaRevert"),e.forEach(function(n){return n.onMatch(n)}),fc=t,ba("matchMedia"))},ku=function(){function r(e,n){this.selector=n&&Ya(n),this.data=[],this._r=[],this.isReverted=!1,this.id=d0++,e&&this.add(e)}var t=r.prototype;return t.add=function(n,i,s){Qt(n)&&(s=i,i=n,n=Qt);var a=this,o=function(){var c=Jt,u=a.selector,f;return c&&c!==a&&c.data.push(a),s&&(a.selector=Ya(s)),Jt=a,f=i.apply(a,arguments),Qt(f)&&a._r.push(f),Jt=c,a.selector=u,a.isReverted=!1,f};return a.last=o,n===Qt?o(a):n?a[n]=o:o},t.ignore=function(n){var i=Jt;Jt=null,n(this),Jt=i},t.getTweens=function(){var n=[];return this.data.forEach(function(i){return i instanceof r?n.push.apply(n,i.getTweens()):i instanceof re&&!(i.parent&&i.parent.data==="nested")&&n.push(i)}),n},t.clear=function(){this._r.length=this.data.length=0},t.kill=function(n,i){var s=this;if(n){var a=this.getTweens();this.data.forEach(function(l){l.data==="isFlip"&&(l.revert(),l.getChildren(!0,!0,!1).forEach(function(c){return a.splice(a.indexOf(c),1)}))}),a.map(function(l){return{g:l.globalTime(0),t:l}}).sort(function(l,c){return c.g-l.g||-1/0}).forEach(function(l){return l.t.revert(n)}),this.data.forEach(function(l){return!(l instanceof re)&&l.revert&&l.revert(n)}),this._r.forEach(function(l){return l(n,s)}),this.isReverted=!0}else this.data.forEach(function(l){return l.kill&&l.kill()});if(this.clear(),i)for(var o=xi.length;o--;)xi[o].id===this.id&&xi.splice(o,1)},t.revert=function(n){this.kill(n||{})},r}(),p0=function(){function r(e){this.contexts=[],this.scope=e}var t=r.prototype;return t.add=function(n,i,s){vn(n)||(n={matches:n});var a=new ku(0,s||this.scope),o=a.conditions={},l,c,u;Jt&&!a.selector&&(a.selector=Jt.selector),this.contexts.push(a),i=a.add("onMatch",i),a.queries=n;for(c in n)c==="all"?u=1:(l=Ye.matchMedia(n[c]),l&&(xi.indexOf(a)<0&&xi.push(a),(o[c]=l.matches)&&(u=1),l.addListener?l.addListener(Za):l.addEventListener("change",Za)));return u&&i(a),this},t.revert=function(n){this.kill(n||{})},t.kill=function(n){this.contexts.forEach(function(i){return i.kill(n,!0)})},r}(),ys={registerPlugin:function(){for(var t=arguments.length,e=new Array(t),n=0;n<t;n++)e[n]=arguments[n];e.forEach(function(i){return wu(i)})},timeline:function(t){return new Re(t)},getTweensOf:function(t,e){return jt.getTweensOf(t,e)},getProperty:function(t,e,n,i){pe(t)&&(t=Ze(t)[0]);var s=_i(t||{}).get,a=n?pu:du;return n==="native"&&(n=""),t&&(e?a((ze[e]&&ze[e].get||s)(t,e,n,i)):function(o,l,c){return a((ze[o]&&ze[o].get||s)(t,o,l,c))})},quickSetter:function(t,e,n){if(t=Ze(t),t.length>1){var i=t.map(function(u){return Ie.quickSetter(u,e,n)}),s=i.length;return function(u){for(var f=s;f--;)i[f](u)}}t=t[0]||{};var a=ze[e],o=_i(t),l=o.harness&&(o.harness.aliases||{})[e]||e,c=a?function(u){var f=new a;ji._pt=0,f.init(t,n?u+n:u,ji,0,[t]),f.render(1,f),ji._pt&&yo(1,ji)}:o.set(t,l);return a?c:function(u){return c(t,l,n?u+n:u,o,1)}},quickTo:function(t,e,n){var i,s=Ie.to(t,yi((i={},i[e]="+=0.1",i.paused=!0,i),n||{})),a=function(l,c,u){return s.resetTo(e,l,c,u)};return a.tween=s,a},isTweening:function(t){return jt.getTweensOf(t,!0).length>0},defaults:function(t){return t&&t.ease&&(t.ease=vi(t.ease,rr.ease)),oc(rr,t||{})},config:function(t){return oc(Ve,t||{})},registerEffect:function(t){var e=t.name,n=t.effect,i=t.plugins,s=t.defaults,a=t.extendTimeline;(i||"").split(",").forEach(function(o){return o&&!ze[o]&&!We[o]&&xs(e+" effect requires "+o+" plugin.")}),Sa[e]=function(o,l,c){return n(Ze(o),Je(l||{},s),c)},a&&(Re.prototype[e]=function(o,l,c){return this.add(Sa[e](o,vn(l)?l:(c=l)&&{},this),c)})},registerEase:function(t,e){Ft[t]=vi(e)},parseEase:function(t,e){return arguments.length?vi(t,e):Ft},getById:function(t){return jt.getById(t)},exportRoot:function(t,e){t===void 0&&(t={});var n=new Re(t),i,s;for(n.smoothChildTiming=Le(t.smoothChildTiming),jt.remove(n),n._dp=0,n._time=n._tTime=jt._time,i=jt._first;i;)s=i._next,(e||!(!i._dur&&i instanceof re&&i.vars.onComplete===i._targets[0]))&&fn(n,i,i._start-i._delay),i=s;return fn(jt,n,0),n},context:function(t,e){return t?new ku(t,e):Jt},matchMedia:function(t){return new p0(t)},matchMediaRefresh:function(){return xi.forEach(function(t){var e=t.conditions,n,i;for(i in e)e[i]&&(e[i]=!1,n=1);n&&t.revert()})||Za()},addEventListener:function(t,e){var n=ms[t]||(ms[t]=[]);~n.indexOf(e)||n.push(e)},removeEventListener:function(t,e){var n=ms[t],i=n&&n.indexOf(e);i>=0&&n.splice(i,1)},utils:{wrap:qg,wrapYoyo:Yg,distribute:Su,random:yu,snap:Eu,normalize:Xg,getUnit:xe,clamp:Hg,splitColor:Ru,toArray:Ze,selector:Ya,mapRange:bu,pipe:Vg,unitize:Wg,interpolate:jg,shuffle:Mu},install:lu,effects:Sa,ticker:He,updateRoot:Re.updateRoot,plugins:ze,globalTimeline:jt,core:{PropTween:Ue,globals:cu,Tween:re,Timeline:Re,Animation:Dr,getCache:_i,_removeLinkedListItem:Ls,reverting:function(){return Me},context:function(t){return t&&Jt&&(Jt.data.push(t),t._ctx=Jt),Jt},suppressOverwrites:function(t){return uo=t}}};De("to,from,fromTo,delayedCall,set,killTweensOf",function(r){return ys[r]=re[r]});He.add(Re.updateRoot);ji=ys.to({},{duration:0});var m0=function(t,e){for(var n=t._pt;n&&n.p!==e&&n.op!==e&&n.fp!==e;)n=n._next;return n},_0=function(t,e){var n=t._targets,i,s,a;for(i in e)for(s=n.length;s--;)a=t._ptLookup[s][i],a&&(a=a.d)&&(a._pt&&(a=m0(a,i)),a&&a.modifier&&a.modifier(e[i],t,n[s],i))},Aa=function(t,e){return{name:t,rawVars:1,init:function(i,s,a){a._onInit=function(o){var l,c;if(pe(s)&&(l={},De(s,function(u){return l[u]=1}),s=l),e){l={};for(c in s)l[c]=e(s[c]);s=l}_0(o,s)}}}},Ie=ys.registerPlugin({name:"attr",init:function(t,e,n,i,s){var a,o,l;this.tween=n;for(a in e)l=t.getAttribute(a)||"",o=this.add(t,"setAttribute",(l||0)+"",e[a],i,s,0,0,a),o.op=a,o.b=l,this._props.push(a)},render:function(t,e){for(var n=e._pt;n;)Me?n.set(n.t,n.p,n.b,n):n.r(t,n.d),n=n._next}},{name:"endArray",init:function(t,e){for(var n=e.length;n--;)this.add(t,n,t[n]||0,e[n],0,0,0,0,0,1)}},Aa("roundProps",ja),Aa("modifiers"),Aa("snap",Eu))||ys;re.version=Re.version=Ie.version="3.12.2";ou=1;fo()&&or();Ft.Power0;Ft.Power1;Ft.Power2;Ft.Power3;Ft.Power4;Ft.Linear;Ft.Quad;Ft.Cubic;Ft.Quart;Ft.Quint;Ft.Strong;Ft.Elastic;Ft.Back;Ft.SteppedEase;Ft.Bounce;Ft.Sine;Ft.Expo;Ft.Circ;/*!
 * CSSPlugin 3.12.2
 * https://greensock.com
 *
 ...
 * Club GreenSock members, the agreement issued with that membership.
 * @author: Jack Doyle, jack@greensock.com
*/var dc,kn,Ji,To,hi,pc,bo,g0=function(){return typeof window<"u"},In={},ci=180/Math.PI,Qi=Math.PI/180,Wi=Math.atan2,mc=1e8,Ao=/([A-Z])/g,v0=/(left|right|width|margin|padding|x)/i,x0=/[\s,\(]\S/,dn={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},$a=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},M0=function(t,e){return e.set(e.t,e.p,t===1?e.e:Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},S0=function(t,e){return e.set(e.t,e.p,t?Math.round((e.s+e.c*t)*1e4)/1e4+e.u:e.b,e)},E0=function(t,e){var n=e.s+e.c*t;e.set(e.t,e.p,~~(n+(n<0?-.5:.5))+e.u,e)},Vu=function(t,e){return e.set(e.t,e.p,t?e.e:e.b,e)},Wu=function(t,e){return e.set(e.t,e.p,t!==1?e.b:e.e,e)},y0=function(t,e,n){return t.style[e]=n},T0=function(t,e,n){return t.style.setProperty(e,n)},b0=function(t,e,n){return t._gsap[e]=n},A0=function(t,e,n){return t._gsap.scaleX=t._gsap.scaleY=n},w0=function(t,e,n,i,s){var a=t._gsap;a.scaleX=a.scaleY=n,a.renderTransform(s,a)},R0=function(t,e,n,i,s){var a=t._gsap;a[e]=n,a.renderTransform(s,a)},Kt="transform",ln=Kt+"Origin",C0=function r(t,e){var n=this,i=this.target,s=i.style;if(t in In&&s){if(this.tfm=this.tfm||{},t!=="transform")t=dn[t]||t,~t.indexOf(",")?t.split(",").forEach(function(a){return n.tfm[a]=Rn(i,a)}):this.tfm[t]=i._gsap.x?i._gsap[t]:Rn(i,t);else return dn.transform.split(",").forEach(function(a){return r.call(n,a,e)});if(this.props.indexOf(Kt)>=0)return;i._gsap.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(ln,e,"")),t=Kt}(s||e)&&this.props.push(t,e,s[t])},Xu=function(t){t.translate&&(t.removeProperty("translate"),t.removeProperty("scale"),t.removeProperty("rotate"))},P0=function(){var t=this.props,e=this.target,n=e.style,i=e._gsap,s,a;for(s=0;s<t.length;s+=3)t[s+1]?e[t[s]]=t[s+2]:t[s+2]?n[t[s]]=t[s+2]:n.removeProperty(t[s].substr(0,2)==="--"?t[s]:t[s].replace(Ao,"-$1").toLowerCase());if(this.tfm){for(a in this.tfm)i[a]=this.tfm[a];i.svg&&(i.renderTransform(),e.setAttribute("data-svg-origin",this.svgo||"")),s=bo(),(!s||!s.isStart)&&!n[Kt]&&(Xu(n),i.uncache=1)}},qu=function(t,e){var n={target:t,props:[],revert:P0,save:C0};return t._gsap||Ie.core.getCache(t),e&&e.split(",").forEach(function(i){return n.save(i)}),n},Yu,Ja=function(t,e){var n=kn.createElementNS?kn.createElementNS((e||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),t):kn.createElement(t);return n.style?n:kn.createElement(t)},_n=function r(t,e,n){var i=getComputedStyle(t);return i[e]||i.getPropertyValue(e.replace(Ao,"-$1").toLowerCase())||i.getPropertyValue(e)||!n&&r(t,lr(e)||e,1)||""},_c="O,Moz,ms,Ms,Webkit".split(","),lr=function(t,e,n){var i=e||hi,s=i.style,a=5;if(t in s&&!n)return t;for(t=t.charAt(0).toUpperCase()+t.substr(1);a--&&!(_c[a]+t in s););return a<0?null:(a===3?"ms":a>=0?_c[a]:"")+t},Qa=function(){g0()&&window.document&&(dc=window,kn=dc.document,Ji=kn.documentElement,hi=Ja("div")||{style:{}},Ja("div"),Kt=lr(Kt),ln=Kt+"Origin",hi.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",Yu=!!lr("perspective"),bo=Ie.core.reverting,To=1)},wa=function r(t){var e=Ja("svg",this.ownerSVGElement&&this.ownerSVGElement.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),n=this.parentNode,i=this.nextSibling,s=this.style.cssText,a;if(Ji.appendChild(e),e.appendChild(this),this.style.display="block",t)try{a=this.getBBox(),this._gsapBBox=this.getBBox,this.getBBox=r}catch{}else this._gsapBBox&&(a=this._gsapBBox());return n&&(i?n.insertBefore(this,i):n.appendChild(this)),Ji.removeChild(e),this.style.cssText=s,a},gc=function(t,e){for(var n=e.length;n--;)if(t.hasAttribute(e[n]))return t.getAttribute(e[n])},ju=function(t){var e;try{e=t.getBBox()}catch{e=wa.call(t,!0)}return e&&(e.width||e.height)||t.getBBox===wa||(e=wa.call(t,!0)),e&&!e.width&&!e.x&&!e.y?{x:+gc(t,["x","cx","x1"])||0,y:+gc(t,["y","cy","y1"])||0,width:0,height:0}:e},Ku=function(t){return!!(t.getCTM&&(!t.parentNode||t.ownerSVGElement)&&ju(t))},Ur=function(t,e){if(e){var n=t.style;e in In&&e!==ln&&(e=Kt),n.removeProperty?((e.substr(0,2)==="ms"||e.substr(0,6)==="webkit")&&(e="-"+e),n.removeProperty(e.replace(Ao,"-$1").toLowerCase())):n.removeAttribute(e)}},Vn=function(t,e,n,i,s,a){var o=new Ue(t._pt,e,n,0,1,a?Wu:Vu);return t._pt=o,o.b=i,o.e=s,t._props.push(n),o},vc={deg:1,rad:1,turn:1},L0={grid:1,flex:1},Zn=function r(t,e,n,i){var s=parseFloat(n)||0,a=(n+"").trim().substr((s+"").length)||"px",o=hi.style,l=v0.test(e),c=t.tagName.toLowerCase()==="svg",u=(c?"client":"offset")+(l?"Width":"Height"),f=100,h=i==="px",m=i==="%",g,_,p,d;return i===a||!s||vc[i]||vc[a]?s:(a!=="px"&&!h&&(s=r(t,e,n,"px")),d=t.getCTM&&Ku(t),(m||a==="%")&&(In[e]||~e.indexOf("adius"))?(g=d?t.getBBox()[l?"width":"height"]:t[u],ee(m?s/g*f:s/100*g)):(o[l?"width":"height"]=f+(h?a:i),_=~e.indexOf("adius")||i==="em"&&t.appendChild&&!c?t:t.parentNode,d&&(_=(t.ownerSVGElement||{}).parentNode),(!_||_===kn||!_.appendChild)&&(_=kn.body),p=_._gsap,p&&m&&p.width&&l&&p.time===He.time&&!p.uncache?ee(s/p.width*f):((m||a==="%")&&!L0[_n(_,"display")]&&(o.position=_n(t,"position")),_===t&&(o.position="static"),_.appendChild(hi),g=hi[u],_.removeChild(hi),o.position="absolute",l&&m&&(p=_i(_),p.time=He.time,p.width=_[u]),ee(h?g*s/f:g&&s?f/g*s:0))))},Rn=function(t,e,n,i){var s;return To||Qa(),e in dn&&e!=="transform"&&(e=dn[e],~e.indexOf(",")&&(e=e.split(",")[0])),In[e]&&e!=="transform"?(s=Nr(t,i),s=e!=="transformOrigin"?s[e]:s.svg?s.origin:bs(_n(t,ln))+" "+s.zOrigin+"px"):(s=t.style[e],(!s||s==="auto"||i||~(s+"").indexOf("calc("))&&(s=Ts[e]&&Ts[e](t,e,n)||_n(t,e)||hu(t,e)||(e==="opacity"?1:0))),n&&!~(s+"").trim().indexOf(" ")?Zn(t,e,s,n)+n:s},D0=function(t,e,n,i){if(!n||n==="none"){var s=lr(e,t,1),a=s&&_n(t,s,1);a&&a!==n?(e=s,n=a):e==="borderColor"&&(n=_n(t,"borderTopColor"))}var o=new Ue(this._pt,t.style,e,0,1,Gu),l=0,c=0,u,f,h,m,g,_,p,d,E,x,S,M;if(o.b=n,o.e=i,n+="",i+="",i==="auto"&&(t.style[e]=i,i=_n(t,e)||i,t.style[e]=n),u=[n,i],Pu(u),n=u[0],i=u[1],h=n.match(Yi)||[],M=i.match(Yi)||[],M.length){for(;f=Yi.exec(i);)p=f[0],E=i.substring(l,f.index),g?g=(g+1)%5:(E.substr(-5)==="rgba("||E.substr(-5)==="hsla(")&&(g=1),p!==(_=h[c++]||"")&&(m=parseFloat(_)||0,S=_.substr((m+"").length),p.charAt(1)==="="&&(p=$i(m,p)+S),d=parseFloat(p),x=p.substr((d+"").length),l=Yi.lastIndex-x.length,x||(x=x||Ve.units[e]||S,l===i.length&&(i+=x,o.e+=x)),S!==x&&(m=Zn(t,e,_,x)||0),o._pt={_next:o._pt,p:E||c===1?E:",",s:m,c:d-m,m:g&&g<4||e==="zIndex"?Math.round:0});o.c=l<i.length?i.substring(l,i.length):""}else o.r=e==="display"&&i==="none"?Wu:Vu;return su.test(i)&&(o.e=0),this._pt=o,o},xc={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},U0=function(t){var e=t.split(" "),n=e[0],i=e[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(t=n,n=i,i=t),e[0]=xc[n]||n,e[1]=xc[i]||i,e.join(" ")},I0=function(t,e){if(e.tween&&e.tween._time===e.tween._dur){var n=e.t,i=n.style,s=e.u,a=n._gsap,o,l,c;if(s==="all"||s===!0)i.cssText="",l=1;else for(s=s.split(","),c=s.length;--c>-1;)o=s[c],In[o]&&(l=1,o=o==="transformOrigin"?ln:Kt),Ur(n,o);l&&(Ur(n,Kt),a&&(a.svg&&n.removeAttribute("transform"),Nr(n,1),a.uncache=1,Xu(i)))}},Ts={clearProps:function(t,e,n,i,s){if(s.data!=="isFromStart"){var a=t._pt=new Ue(t._pt,e,n,0,0,I0);return a.u=i,a.pr=-10,a.tween=s,t._props.push(n),1}}},Ir=[1,0,0,1,0,0],Zu={},$u=function(t){return t==="matrix(1, 0, 0, 1, 0, 0)"||t==="none"||!t},Mc=function(t){var e=_n(t,Kt);return $u(e)?Ir:e.substr(7).match(ru).map(ee)},wo=function(t,e){var n=t._gsap||_i(t),i=t.style,s=Mc(t),a,o,l,c;return n.svg&&t.getAttribute("transform")?(l=t.transform.baseVal.consolidate().matrix,s=[l.a,l.b,l.c,l.d,l.e,l.f],s.join(",")==="1,0,0,1,0,0"?Ir:s):(s===Ir&&!t.offsetParent&&t!==Ji&&!n.svg&&(l=i.display,i.display="block",a=t.parentNode,(!a||!t.offsetParent)&&(c=1,o=t.nextElementSibling,Ji.appendChild(t)),s=Mc(t),l?i.display=l:Ur(t,"display"),c&&(o?a.insertBefore(t,o):a?a.appendChild(t):Ji.removeChild(t))),e&&s.length>6?[s[0],s[1],s[4],s[5],s[12],s[13]]:s)},to=function(t,e,n,i,s,a){var o=t._gsap,l=s||wo(t,!0),c=o.xOrigin||0,u=o.yOrigin||0,f=o.xOffset||0,h=o.yOffset||0,m=l[0],g=l[1],_=l[2],p=l[3],d=l[4],E=l[5],x=e.split(" "),S=parseFloat(x[0])||0,M=parseFloat(x[1])||0,w,A,L,v;n?l!==Ir&&(A=m*p-g*_)&&(L=S*(p/A)+M*(-_/A)+(_*E-p*d)/A,v=S*(-g/A)+M*(m/A)-(m*E-g*d)/A,S=L,M=v):(w=ju(t),S=w.x+(~x[0].indexOf("%")?S/100*w.width:S),M=w.y+(~(x[1]||x[0]).indexOf("%")?M/100*w.height:M)),i||i!==!1&&o.smooth?(d=S-c,E=M-u,o.xOffset=f+(d*m+E*_)-d,o.yOffset=h+(d*g+E*p)-E):o.xOffset=o.yOffset=0,o.xOrigin=S,o.yOrigin=M,o.smooth=!!i,o.origin=e,o.originIsAbsolute=!!n,t.style[ln]="0px 0px",a&&(Vn(a,o,"xOrigin",c,S),Vn(a,o,"yOrigin",u,M),Vn(a,o,"xOffset",f,o.xOffset),Vn(a,o,"yOffset",h,o.yOffset)),t.setAttribute("data-svg-origin",S+" "+M)},Nr=function(t,e){var n=t._gsap||new Iu(t);if("x"in n&&!e&&!n.uncache)return n;var i=t.style,s=n.scaleX<0,a="px",o="deg",l=getComputedStyle(t),c=_n(t,ln)||"0",u,f,h,m,g,_,p,d,E,x,S,M,w,A,L,v,b,X,Z,U,F,B,K,G,W,Q,$,z,k,ot,it,st;return u=f=h=_=p=d=E=x=S=0,m=g=1,n.svg=!!(t.getCTM&&Ku(t)),l.translate&&((l.translate!=="none"||l.scale!=="none"||l.rotate!=="none")&&(i[Kt]=(l.translate!=="none"?"translate3d("+(l.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(l.rotate!=="none"?"rotate("+l.rotate+") ":"")+(l.scale!=="none"?"scale("+l.scale.split(" ").join(",")+") ":"")+(l[Kt]!=="none"?l[Kt]:"")),i.scale=i.rotate=i.translate="none"),A=wo(t,n.svg),n.svg&&(n.uncache?(W=t.getBBox(),c=n.xOrigin-W.x+"px "+(n.yOrigin-W.y)+"px",G=""):G=!e&&t.getAttribute("data-svg-origin"),to(t,G||c,!!G||n.originIsAbsolute,n.smooth!==!1,A)),M=n.xOrigin||0,w=n.yOrigin||0,A!==Ir&&(X=A[0],Z=A[1],U=A[2],F=A[3],u=B=A[4],f=K=A[5],A.length===6?(m=Math.sqrt(X*X+Z*Z),g=Math.sqrt(F*F+U*U),_=X||Z?Wi(Z,X)*ci:0,E=U||F?Wi(U,F)*ci+_:0,E&&(g*=Math.abs(Math.cos(E*Qi))),n.svg&&(u-=M-(M*X+w*U),f-=w-(M*Z+w*F))):(st=A[6],ot=A[7],$=A[8],z=A[9],k=A[10],it=A[11],u=A[12],f=A[13],h=A[14],L=Wi(st,k),p=L*ci,L&&(v=Math.cos(-L),b=Math.sin(-L),G=B*v+$*b,W=K*v+z*b,Q=st*v+k*b,$=B*-b+$*v,z=K*-b+z*v,k=st*-b+k*v,it=ot*-b+it*v,B=G,K=W,st=Q),L=Wi(-U,k),d=L*ci,L&&(v=Math.cos(-L),b=Math.sin(-L),G=X*v-$*b,W=Z*v-z*b,Q=U*v-k*b,it=F*b+it*v,X=G,Z=W,U=Q),L=Wi(Z,X),_=L*ci,L&&(v=Math.cos(L),b=Math.sin(L),G=X*v+Z*b,W=B*v+K*b,Z=Z*v-X*b,K=K*v-B*b,X=G,B=W),p&&Math.abs(p)+Math.abs(_)>359.9&&(p=_=0,d=180-d),m=ee(Math.sqrt(X*X+Z*Z+U*U)),g=ee(Math.sqrt(K*K+st*st)),L=Wi(B,K),E=Math.abs(L)>2e-4?L*ci:0,S=it?1/(it<0?-it:it):0),n.svg&&(G=t.getAttribute("transform"),n.forceCSS=t.setAttribute("transform","")||!$u(_n(t,Kt)),G&&t.setAttribute("transform",G))),Math.abs(E)>90&&Math.abs(E)<270&&(s?(m*=-1,E+=_<=0?180:-180,_+=_<=0?180:-180):(g*=-1,E+=E<=0?180:-180)),e=e||n.uncache,n.x=u-((n.xPercent=u&&(!e&&n.xPercent||(Math.round(t.offsetWidth/2)===Math.round(-u)?-50:0)))?t.offsetWidth*n.xPercent/100:0)+a,n.y=f-((n.yPercent=f&&(!e&&n.yPercent||(Math.round(t.offsetHeight/2)===Math.round(-f)?-50:0)))?t.offsetHeight*n.yPercent/100:0)+a,n.z=h+a,n.scaleX=ee(m),n.scaleY=ee(g),n.rotation=ee(_)+o,n.rotationX=ee(p)+o,n.rotationY=ee(d)+o,n.skewX=E+o,n.skewY=x+o,n.transformPerspective=S+a,(n.zOrigin=parseFloat(c.split(" ")[2])||0)&&(i[ln]=bs(c)),n.xOffset=n.yOffset=0,n.force3D=Ve.force3D,n.renderTransform=n.svg?O0:Yu?Ju:N0,n.uncache=0,n},bs=function(t){return(t=t.split(" "))[0]+" "+t[1]},Ra=function(t,e,n){var i=xe(e);return ee(parseFloat(e)+parseFloat(Zn(t,"x",n+"px",i)))+i},N0=function(t,e){e.z="0px",e.rotationY=e.rotationX="0deg",e.force3D=0,Ju(t,e)},si="0deg",vr="0px",ai=") ",Ju=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.z,c=n.rotation,u=n.rotationY,f=n.rotationX,h=n.skewX,m=n.skewY,g=n.scaleX,_=n.scaleY,p=n.transformPerspective,d=n.force3D,E=n.target,x=n.zOrigin,S="",M=d==="auto"&&t&&t!==1||d===!0;if(x&&(f!==si||u!==si)){var w=parseFloat(u)*Qi,A=Math.sin(w),L=Math.cos(w),v;w=parseFloat(f)*Qi,v=Math.cos(w),a=Ra(E,a,A*v*-x),o=Ra(E,o,-Math.sin(w)*-x),l=Ra(E,l,L*v*-x+x)}p!==vr&&(S+="perspective("+p+ai),(i||s)&&(S+="translate("+i+"%, "+s+"%) "),(M||a!==vr||o!==vr||l!==vr)&&(S+=l!==vr||M?"translate3d("+a+", "+o+", "+l+") ":"translate("+a+", "+o+ai),c!==si&&(S+="rotate("+c+ai),u!==si&&(S+="rotateY("+u+ai),f!==si&&(S+="rotateX("+f+ai),(h!==si||m!==si)&&(S+="skew("+h+", "+m+ai),(g!==1||_!==1)&&(S+="scale("+g+", "+_+ai),E.style[Kt]=S||"translate(0, 0)"},O0=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.rotation,c=n.skewX,u=n.skewY,f=n.scaleX,h=n.scaleY,m=n.target,g=n.xOrigin,_=n.yOrigin,p=n.xOffset,d=n.yOffset,E=n.forceCSS,x=parseFloat(a),S=parseFloat(o),M,w,A,L,v;l=parseFloat(l),c=parseFloat(c),u=parseFloat(u),u&&(u=parseFloat(u),c+=u,l+=u),l||c?(l*=Qi,c*=Qi,M=Math.cos(l)*f,w=Math.sin(l)*f,A=Math.sin(l-c)*-h,L=Math.cos(l-c)*h,c&&(u*=Qi,v=Math.tan(c-u),v=Math.sqrt(1+v*v),A*=v,L*=v,u&&(v=Math.tan(u),v=Math.sqrt(1+v*v),M*=v,w*=v)),M=ee(M),w=ee(w),A=ee(A),L=ee(L)):(M=f,L=h,w=A=0),(x&&!~(a+"").indexOf("px")||S&&!~(o+"").indexOf("px"))&&(x=Zn(m,"x",a,"px"),S=Zn(m,"y",o,"px")),(g||_||p||d)&&(x=ee(x+g-(g*M+_*A)+p),S=ee(S+_-(g*w+_*L)+d)),(i||s)&&(v=m.getBBox(),x=ee(x+i/100*v.width),S=ee(S+s/100*v.height)),v="matrix("+M+","+w+","+A+","+L+","+x+","+S+")",m.setAttribute("transform",v),E&&(m.style[Kt]=v)},F0=function(t,e,n,i,s){var a=360,o=pe(s),l=parseFloat(s)*(o&&~s.indexOf("rad")?ci:1),c=l-i,u=i+c+"deg",f,h;return o&&(f=s.split("_")[1],f==="short"&&(c%=a,c!==c%(a/2)&&(c+=c<0?a:-a)),f==="cw"&&c<0?c=(c+a*mc)%a-~~(c/a)*a:f==="ccw"&&c>0&&(c=(c-a*mc)%a-~~(c/a)*a)),t._pt=h=new Ue(t._pt,e,n,i,c,M0),h.e=u,h.u="deg",t._props.push(n),h},Sc=function(t,e){for(var n in e)t[n]=e[n];return t},B0=function(t,e,n){var i=Sc({},n._gsap),s="perspective,force3D,transformOrigin,svgOrigin",a=n.style,o,l,c,u,f,h,m,g;i.svg?(c=n.getAttribute("transform"),n.setAttribute("transform",""),a[Kt]=e,o=Nr(n,1),Ur(n,Kt),n.setAttribute("transform",c)):(c=getComputedStyle(n)[Kt],a[Kt]=e,o=Nr(n,1),a[Kt]=c);for(l in In)c=i[l],u=o[l],c!==u&&s.indexOf(l)<0&&(m=xe(c),g=xe(u),f=m!==g?Zn(n,l,c,g):parseFloat(c),h=parseFloat(u),t._pt=new Ue(t._pt,o,l,f,h-f,$a),t._pt.u=g||0,t._props.push(l));Sc(o,i)};De("padding,margin,Width,Radius",function(r,t){var e="Top",n="Right",i="Bottom",s="Left",a=(t<3?[e,n,i,s]:[e+s,e+n,i+n,i+s]).map(function(o){return t<2?r+o:"border"+o+r});Ts[t>1?"border"+r:r]=function(o,l,c,u,f){var h,m;if(arguments.length<4)return h=a.map(function(g){return Rn(o,g,c)}),m=h.join(" "),m.split(h[0]).length===5?h[0]:m;h=(u+"").split(" "),m={},a.forEach(function(g,_){return m[g]=h[_]=h[_]||h[(_-1)/2|0]}),o.init(l,m,f)}});var Qu={name:"css",register:Qa,targetTest:function(t){return t.style&&t.nodeType},init:function(t,e,n,i,s){var a=this._props,o=t.style,l=n.vars.startAt,c,u,f,h,m,g,_,p,d,E,x,S,M,w,A,L;To||Qa(),this.styles=this.styles||qu(t),L=this.styles.props,this.tween=n;for(_ in e)if(_!=="autoRound"&&(u=e[_],!(ze[_]&&Nu(_,e,n,i,t,s)))){if(m=typeof u,g=Ts[_],m==="function"&&(u=u.call(n,i,t,s),m=typeof u),m==="string"&&~u.indexOf("random(")&&(u=Pr(u)),g)g(this,t,_,u,n)&&(A=1);else if(_.substr(0,2)==="--")c=(getComputedStyle(t).getPropertyValue(_)+"").trim(),u+="",Yn.lastIndex=0,Yn.test(c)||(p=xe(c),d=xe(u)),d?p!==d&&(c=Zn(t,_,c,d)+d):p&&(u+=p),this.add(o,"setProperty",c,u,i,s,0,0,_),a.push(_),L.push(_,0,o[_]);else if(m!=="undefined"){if(l&&_ in l?(c=typeof l[_]=="function"?l[_].call(n,i,t,s):l[_],pe(c)&&~c.indexOf("random(")&&(c=Pr(c)),xe(c+"")||(c+=Ve.units[_]||xe(Rn(t,_))||""),(c+"").charAt(1)==="="&&(c=Rn(t,_))):c=Rn(t,_),h=parseFloat(c),E=m==="string"&&u.charAt(1)==="="&&u.substr(0,2),E&&(u=u.substr(2)),f=parseFloat(u),_ in dn&&(_==="autoAlpha"&&(h===1&&Rn(t,"visibility")==="hidden"&&f&&(h=0),L.push("visibility",0,o.visibility),Vn(this,o,"visibility",h?"inherit":"hidden",f?"inherit":"hidden",!f)),_!=="scale"&&_!=="transform"&&(_=dn[_],~_.indexOf(",")&&(_=_.split(",")[0]))),x=_ in In,x){if(this.styles.save(_),S||(M=t._gsap,M.renderTransform&&!e.parseTransform||Nr(t,e.parseTransform),w=e.smoothOrigin!==!1&&M.smooth,S=this._pt=new Ue(this._pt,o,Kt,0,1,M.renderTransform,M,0,-1),S.dep=1),_==="scale")this._pt=new Ue(this._pt,M,"scaleY",M.scaleY,(E?$i(M.scaleY,E+f):f)-M.scaleY||0,$a),this._pt.u=0,a.push("scaleY",_),_+="X";else if(_==="transformOrigin"){L.push(ln,0,o[ln]),u=U0(u),M.svg?to(t,u,0,w,0,this):(d=parseFloat(u.split(" ")[2])||0,d!==M.zOrigin&&Vn(this,M,"zOrigin",M.zOrigin,d),Vn(this,o,_,bs(c),bs(u)));continue}else if(_==="svgOrigin"){to(t,u,1,w,0,this);continue}else if(_ in Zu){F0(this,M,_,h,E?$i(h,E+u):u);continue}else if(_==="smoothOrigin"){Vn(this,M,"smooth",M.smooth,u);continue}else if(_==="force3D"){M[_]=u;continue}else if(_==="transform"){B0(this,u,t);continue}}else _ in o||(_=lr(_)||_);if(x||(f||f===0)&&(h||h===0)&&!x0.test(u)&&_ in o)p=(c+"").substr((h+"").length),f||(f=0),d=xe(u)||(_ in Ve.units?Ve.units[_]:p),p!==d&&(h=Zn(t,_,c,d)),this._pt=new Ue(this._pt,x?M:o,_,h,(E?$i(h,E+f):f)-h,!x&&(d==="px"||_==="zIndex")&&e.autoRound!==!1?E0:$a),this._pt.u=d||0,p!==d&&d!=="%"&&(this._pt.b=c,this._pt.r=S0);else if(_ in o)D0.call(this,t,_,c,E?E+u:u);else if(_ in t)this.add(t,_,c||t[_],E?E+u:u,i,s);else if(_!=="parseTransform"){mo(_,u);continue}x||(_ in o?L.push(_,0,o[_]):L.push(_,1,c||t[_])),a.push(_)}}A&&Hu(this)},render:function(t,e){if(e.tween._time||!bo())for(var n=e._pt;n;)n.r(t,n.d),n=n._next;else e.styles.revert()},get:Rn,aliases:dn,getSetter:function(t,e,n){var i=dn[e];return i&&i.indexOf(",")<0&&(e=i),e in In&&e!==ln&&(t._gsap.x||Rn(t,"x"))?n&&pc===n?e==="scale"?A0:b0:(pc=n||{})&&(e==="scale"?w0:R0):t.style&&!ho(t.style[e])?y0:~e.indexOf("-")?T0:Eo(t,e)},core:{_removeProperty:Ur,_getMatrix:wo}};Ie.utils.checkPrefix=lr;Ie.core.getStyleSaver=qu;(function(r,t,e,n){var i=De(r+","+t+","+e,function(s){In[s]=1});De(t,function(s){Ve.units[s]="deg",Zu[s]=1}),dn[i[13]]=r+","+t,De(n,function(s){var a=s.split(":");dn[a[1]]=i[a[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");De("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(r){Ve.units[r]="px"});Ie.registerPlugin(Qu);var Ro=Ie.registerPlugin(Qu)||Ie;Ro.core.Tween;const Is=new vg,z0=new co(3,64,64),G0=new xg({color:"magenta",roughness:.2,transparent:!0}),Ns=new Ln(z0,G0);Is.add(Ns);Ns.position.set(0,2,0);const we={width:window.innerWidth,height:window.innerHeight},Co=new yg(13421772,1,30);Co.position.set(0,10,10);Co.intensity=5;Is.add(Co);const cr=new Ge(45,we.width/we.height,.1,100);cr.position.z=20;Is.add(cr);const Os=document.querySelector(".webgl");Os.width=we.width;Os.height=we.height;const th=new tu({canvas:Os,alpha:!0}),hr=new Tg(cr,Os);hr.enableDamping=!0;hr.enablePan=!1;hr.enableZoom=!1;hr.autoRotate=!0;hr.autoRotateSpeed=7;window.addEventListener("resize",()=>{we.width=window.innerWidth,we.height=window.innerHeight,cr.aspect=we.width/we.height,cr.updateProjectionMatrix(),th.setSize(we.width,we.height)});const eh=()=>{hr.update(),th.render(Is,cr),window.requestAnimationFrame(eh)};eh();let Po=!1,As=[];window.addEventListener("mousedown",()=>Po=!0);window.addEventListener("mouseup",()=>Po=!1);window.addEventListener("mousemove",r=>{if(Po){As=[Math.round(r.pageX/we.width*255),Math.round(r.pageY/we.height*255),150];let t=new kt(`rgb(${As.join(",")})`);Ro.to(Ns.material.color,{r:t.r,g:t.g,b:t.b})}});window.addEventListener("touchmove",r=>{{As=[Math.round(r.touches[0].pageX/we.width*255),Math.round(r.touches[0].pageY/we.height*255),150];let t=new kt(`rgb(${As.join(",")})`);Ro.to(Ns.material.color,{r:t.r,g:t.g,b:t.b})}});const nh=document.querySelector(".menu-toggle"),eo=document.querySelector(".menu-wrapper"),ih=document.querySelector(".close-btn"),rh=document.querySelectorAll(".menu li");let no;function H0(){if(nh.classList.toggle("active"),eo.classList.toggle("show-menu"),eo.classList.contains("show-menu")){let r=0;rh.forEach((t,e)=>{setTimeout(()=>{t.style.opacity=1},r),r+=200}),clearInterval(no)}}function k0(){let r=1;const t=10,e=50,n=1/t;no=setInterval(()=>{r-=n,rh.forEach(i=>{i.style.opacity=Math.max(0,r)}),ih.style.opacity=Math.max(0,r),r<=0&&(clearInterval(no),eo.classList.toggle("show-menu"))},e)}nh.addEventListener("click",H0);ih.addEventListener("click",k0);const ws=["fun","beautiful","exciting","magical","whimsical","new","daring","creative"],Ca=document.querySelector(".dynamic-text");let Pa=0,Ar=!1;function sh(r){let n=0,i=!1;Ca.className=`dynamic-text ${r}`;function s(){Ar||(n<r.length&&!i?(Ca.textContent=r.substring(0,n+1),n++,setTimeout(s,100)):(i=!0,n=r.length,setTimeout(a,1500)))}function a(){Ar||(n>=0&&i?(Ca.textContent=r.substring(0,n),n--,setTimeout(a,10)):(i=!1,Ar=!0,setTimeout(V0,100*3)))}s()}function V0(){Ar&&(Pa=(Pa+1)%ws.length,Ar=!1,sh(ws[Pa]))}sh(ws[ws.length-1]);const Ec=document.querySelector(".to-top");window.addEventListener("scroll",()=>{window.pageYOffset>100?Ec.classList.add("active"):Ec.classList.remove("active")});const Lo=document.getElementById("message");Lo.addEventListener("focus",function(){this.classList.contains("empty")&&(this.value="",this.classList.remove("empty"))});Lo.addEventListener("blur",function(){this.value.trim()||(this.value="write your message here . . .",this.classList.add("empty"))});Lo.addEventListener("input",function(){this.classList.contains("empty")&&this.classList.remove("empty")});
